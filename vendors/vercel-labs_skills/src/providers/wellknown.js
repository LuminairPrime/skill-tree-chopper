...
exports.wellKnownProvider = exports.WellKnownProvider = void 0;
...
class WellKnownProvider {
    constructor() {
        this.id = 'well-known';
        this.displayName = 'Well-Known Skills';
        this.WELL_KNOWN_PATHS = ['.well-known/agent-skills', '.well-known/skills'];
        this.INDEX_FILE = 'index.json';
    }
    /**
...
exports.WellKnownProvider = WellKnownProvider;
exports.wellKnownProvider = new WellKnownProvider();
