...
exports.toSkillSlug = toSkillSlug;
exports.fetchRepoTree = fetchRepoTree;
exports.getSkillFolderHashFromTree = getSkillFolderHashFromTree;
exports.findSkillMdPaths = findSkillMdPaths;
exports.tryBlobInstall = tryBlobInstall;
...
async function tryBlobInstall(ownerRepo, options = {}) {
    ...
    for (const { mdPath, content } of mdFetches) {
        ...
        if (isInternal && !options.includeInternal)
            continue;
        const safeName = (0, sanitize_ts_1.sanitizeMetadata)(data.name);
        const safeDescription = (0, sanitize_ts_1.sanitizeMetadata)(data.description);
        parsedSkills.push({
            mdPath,
            name: safeName,
