...
test_1.test.describe.skip('AI Agent Detection', () => {
    let extensionHelper;
    let terminalHelper;
    let webviewHelper;
     ...
     */
    (0, test_1.test)('should detect Claude Code agent from startup message @P0 @ai-agent-detection', async () => {
        // Arrange: Load Claude Code startup fixture
        const claudeStartup = (0, fs_1.readFileSync)(`${test_constants_1.TEST_PATHS.AI_AGENT_OUTPUT}/claude-code-startup.txt`, 'utf-8');
     ...
     */
    (0, test_1.test)('should track Claude Code status transitions @P0 @ai-agent-detection', async () => {
     ...
     * its startup message.
     */
    (0, test_1.test)('should detect GitHub Copilot agent @P1 @ai-agent-detection', async () => {
        // Arrange: Load GitHub Copilot startup fixture
        const copilotStartup = (0, fs_1.readFileSync)(`${test_constants_1.TEST_PATHS.AI_AGENT_OUTPUT}/github-copilot-startup.txt`, 'utf-8');
     ...
     * - "gh copilot"
     */
    (0, test_1.test)('should detect GitHub Copilot variants @P1 @ai-agent-detection', async ({ page: _page }) => {
     ...
     */
    (0, test_1.test)('should detect Gemini CLI agent @P1 @ai-agent-detection', async () => {
        // Arrange: Load Gemini CLI startup fixture
        const geminiStartup = (0, fs_1.readFileSync)(`${test_constants_1.TEST_PATHS.AI_AGENT_OUTPUT}/gemini-cli-startup.txt`, 'utf-8');
     ...
     */
    (0, test_1.test)('should detect different agents in different terminals @P1 @ai-agent-detection', async () => {
     ...
     */
    (0, test_1.test)('should prevent false positives from substring matches @P0 @ai-agent-detection @security', async () => {
     ...
     */
    (0, test_1.test)('should use regex with word boundaries for detection @P0 @ai-agent-detection @security', async () => {
     ...
     */
    (0, test_1.test)('should detect agent within 500ms @P2 @performance', async () => {
        // Arrange: Load Claude Code startup
        const claudeStartup = (0, fs_1.readFileSync)(`${test_constants_1.TEST_PATHS.AI_AGENT_OUTPUT}/claude-code-startup.txt`, 'utf-8');
        ...
        (0, test_1.expect)(duration).toBeLessThan(500);
     ...
     */
    (0, test_1.test)('should display visual status indicator for detected agent @P1 @ai-agent-detection @visual', async ({ page: _page, }) => {
        // Arrange: Load Claude Code startup
        const claudeStartup = (0, fs_1.readFileSync)(`${test_constants_1.TEST_PATHS.AI_AGENT_OUTPUT}/claude-code-startup.txt`, 'utf-8');
        // Act: Send startup message
        await terminalHelper.sendText(1, claudeStartup);
...
//# sourceMappingURL=detection.spec.js.map