...
test_1.test.describe.skip('AI Agent Detection', () => {
   ...
   */
  (0, test_1.test)(
    'should detect Claude Code agent from startup message @P0 @ai-agent-detection',
    async () => {
      // Arrange: Load Claude Code startup fixture
      const claudeStartup = (0, fs_1.readFileSync)(
        `${test_constants_1.TEST_PATHS.AI_AGENT_OUTPUT}/claude-code-startup.txt`,
        'utf-8'
      );
   ...
   */
  (0, test_1.test)(
    'should track Claude Code status transitions @P0 @ai-agent-detection',
    async () => {
  ...
  (0, test_1.test)('should detect GitHub Copilot agent @P1 @ai-agent-detection', async () => {
    ...
    const copilotStartup = (0, fs_1.readFileSync)(
      `${test_constants_1.TEST_PATHS.AI_AGENT_OUTPUT}/github-copilot-startup.txt`,
      'utf-8'
    );
   ...
   */
  (0, test_1.test)(
    'should detect GitHub Copilot variants @P1 @ai-agent-detection',
    async ({ page: _page }) => {
  ...
  (0, test_1.test)('should detect Gemini CLI agent @P1 @ai-agent-detection', async () => {
    ...
    const geminiStartup = (0, fs_1.readFileSync)(
      `${test_constants_1.TEST_PATHS.AI_AGENT_OUTPUT}/gemini-cli-startup.txt`,
      'utf-8'
    );
   ...
   */
  (0, test_1.test)(
    'should detect different agents in different terminals @P1 @ai-agent-detection',
    async () => {
   ...
   */
  (0, test_1.test)(
    'should prevent false positives from substring matches @P0 @ai-agent-detection @security',
    async () => {
   ...
   */
  (0, test_1.test)(
    'should use regex with word boundaries for detection @P0 @ai-agent-detection @security',
    async () => {
   ...
   */
  (0, test_1.test)(
    'should display visual status indicator for detected agent @P1 @ai-agent-detection @visual',
    async ({ page: _page }) => {
      // Arrange: Load Claude Code startup
      const claudeStartup = (0, fs_1.readFileSync)(
        `${test_constants_1.TEST_PATHS.AI_AGENT_OUTPUT}/claude-code-startup.txt`,
