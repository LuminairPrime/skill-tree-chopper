...
test_1.test.describe.skip('Error Scenarios', () => {
   ...
   */
  (0, test_1.test)(
    'should handle extension activation failure gracefully @P0 @error-handling',
    async ({ page: _page }) => {
   ...
   */
  (0, test_1.test)(
    'should handle WebView initialization failure @P0 @error-handling',
    async ({ page: _page }) => {
   ...
   */
  (0, test_1.test)(
    'should handle terminal crash and allow recovery @P0 @error-handling',
    async ({ page: _page }) => {
   ...
   */
  (0, test_1.test)(
    'should handle session restore failure gracefully @P1 @error-handling',
    async () => {
   ...
   */
  (0, test_1.test)(
    'should handle WebView message failures @P1 @error-handling',
    async ({ page: _page }) => {
