...
test_1.test.describe.skip('Configuration Settings', () => {
    let extensionHelper;
    let terminalHelper;
    let webviewHelper;
     ...
     */
    (0, test_1.test)('should apply font size change @P0 @configuration', async () => {
        ...
        (0, test_1.expect)(newSize).toBe(16);
        (0, test_1.expect)(newSize).not.toBe(initialSize);
     ...
     */
    (0, test_1.test)('should apply font family change @P1 @configuration', async () => {
        ...
        (0, test_1.expect)(fontFamily).toBe(newFont);
     ...
     */
    (0, test_1.test)('should enforce max terminals limit configuration @P0 @configuration', async () => {
     ...
     */
    (0, test_1.test)('should restore default max terminals limit @P1 @configuration', async () => {
        ...
        (0, test_1.expect)(maxTerminals).toBe(test_constants_1.TERMINAL_CONSTANTS.MAX_TERMINALS);
     ...
     */
    (0, test_1.test)('should toggle persistent sessions feature @P1 @configuration', async () => {
        ...
        const persistentSessions = await extensionHelper.getConfiguration('secondaryTerminal.enablePersistentSessions');
        (0, test_1.expect)(persistentSessions).toBe(false);
        ...
        const enabled = await extensionHelper.getConfiguration('secondaryTerminal.enablePersistentSessions');
        (0, test_1.expect)(enabled).toBe(true);
    });
    /**
     ...
     */
    (0, test_1.test)('should toggle AI agent detection feature @P1 @configuration', async () => {
        // Act: Disable AI agent detection
        await extensionHelper.updateConfiguration('secondaryTerminal.enableAIAgentDetection', false);
        // Assert: Feature should be disabled
        const aiDetection = await extensionHelper.getConfiguration('secondaryTerminal.enableAIAgentDetection');
        (0, test_1.expect)(aiDetection).toBe(false);
        // Act: Re-enable
        await extensionHelper.updateConfiguration('secondaryTerminal.enableAIAgentDetection', true);
        // Assert: Feature should be enabled
        const enabled = await extensionHelper.getConfiguration('secondaryTerminal.enableAIAgentDetection');
        (0, test_1.expect)(enabled).toBe(true);
    });
    /**
     ...
     */
    (0, test_1.test)('should configure scrollback line limit @P1 @configuration', async () => {
        ...
        (0, test_1.expect)(scrollback).toBe(5000);
        // Restore default
     ...
     */
    (0, test_1.test)('should configure terminal theme @P1 @configuration', async () => {
        // Test auto theme
        ...
        (0, test_1.expect)(theme).toBe('auto');
        // Test dark theme
     ...
     * handled gracefully.
     */
    (0, test_1.test)('should handle invalid configuration values gracefully @P0 @configuration', async () => {
        ...
        (0, test_1.expect)(fontSize).toBeGreaterThan(0);
        ...
        const maxTerminals = await extensionHelper.getConfiguration('secondaryTerminal.maxTerminals');
        (0, test_1.expect)(maxTerminals).toBeGreaterThan(0);
    });
    /**
     ...
     */
    (0, test_1.test)('should persist configuration changes @P1 @configuration', async () => {
        ...
        const fontSize = await extensionHelper.getConfiguration('secondaryTerminal.fontSize');
        (0, test_1.expect)(fontSize).toBe(18);
        // Cleanup
        await extensionHelper.updateConfiguration('secondaryTerminal.fontSize', 14);
    });
    /**
     ...
     */
    (0, test_1.test)('should handle multiple configuration changes @P1 @configuration', async () => {
