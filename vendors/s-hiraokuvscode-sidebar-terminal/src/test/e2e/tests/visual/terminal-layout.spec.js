 ...
 */
test_1.test.describe('Terminal Layout @visual-regression', () => {
  let vrtHelper;
   ...
   */
  (0, test_1.test)('should render single active terminal correctly @P0', async ({ page }) => {
    ...
    await (0, test_1.expect)(terminalBody).toHaveScreenshot('terminal-single-active.png');
  });
  /**
   ...
   */
  (0, test_1.test)('should render single inactive terminal correctly @P0', async ({ page }) => {
    ...
    const terminalBody = page.locator('#terminal-body');
    await (0, test_1.expect)(terminalBody).toHaveScreenshot('terminal-single-inactive.png');
  });
  /**
   ...
   * renders correctly.
   */
  (0, test_1.test)('should render terminal header correctly @P1', async ({ page }) => {
    // Assert: Visual comparison of the header
    const header = page.locator('#header');
    await (0, test_1.expect)(header).toHaveScreenshot('terminal-header.png');
  });
  /**
   ...
   */
  (0, test_1.test)('should render terminal tabs correctly @P1', async ({ page }) => {
    // Assert: Visual comparison of the tab list
    const tabList = page.locator('.terminal-tabs');
    await (0, test_1.expect)(tabList).toHaveScreenshot('terminal-tabs-single.png');
  });
  /**
   ...
   */
  (0, test_1.test)('should render full page layout correctly @P0', async ({ page }) => {
    // Inject sample content
    await vrtHelper.injectTerminalContent(
      'user@host:~$ npm run build\n> Building...\n> Build successful!'
    );
    // Assert: Visual comparison of full page
    await (0, test_1.expect)(page).toHaveScreenshot('terminal-full-layout.png', {
      fullPage: true,
    });
  });
});
 ...
 */
test_1.test.describe('Split Terminal Layout @visual-regression', () => {
  let vrtHelper;
  test_1.test.beforeEach(async ({ page }) => {
    vrtHelper = new helpers_1.VRTHelper(page);
    await page.goto('/standalone-webview.html');
   ...
   */
  (0, test_1.test)('should render vertical split layout correctly @P0', async ({ page }) => {
    ...
    // Assert: Visual comparison
    const terminalBody = page.locator('#terminal-body');
    await (0, test_1.expect)(terminalBody).toHaveScreenshot('terminal-split-vertical.png');
  });
  /**
   ...
   */
  (0, test_1.test)('should render horizontal split layout correctly @P0', async ({ page }) => {
    ...
    // Assert: Visual comparison
    const terminalBody = page.locator('#terminal-body');
    await (0, test_1.expect)(terminalBody).toHaveScreenshot('terminal-split-horizontal.png');
  });
  /**
   ...
   */
  (0, test_1.test)('should render three-way vertical split correctly @P1', async ({ page }) => {
    ...
    // Assert: Visual comparison
    const terminalBody = page.locator('#terminal-body');
    await (0, test_1.expect)(terminalBody).toHaveScreenshot('terminal-split-three-vertical.png');
  });
  /**
   ...
   */
  (0, test_1.test)('should render split resizer correctly @P1', async ({ page }) => {
    // Arrange: Set up split layout
    await vrtHelper.setSplitLayout('vertical', 2);
    // Assert: Check resizer is visible
    const resizer = page.locator('.split-resizer');
    await (0, test_1.expect)(resizer).toBeVisible();
    // Visual comparison of full terminal body including resizer
    const terminalBody = page.locator('#terminal-body');
    await (0, test_1.expect)(terminalBody).toHaveScreenshot('terminal-split-resizer.png');
  });
});
/**
 ...
 */
test_1.test.describe('Terminal Action Buttons @visual-regression', () => {
  let vrtHelper;
  test_1.test.beforeEach(async ({ page }) => {
    vrtHelper = new helpers_1.VRTHelper(page);
    await page.goto('/standalone-webview.html');
   ...
   */
  (0, test_1.test)('should render action buttons in default state @P1', async ({ page }) => {
    // Assert: Visual comparison of action buttons
    const headerRight = page.locator('.header-right');
    await (0, test_1.expect)(headerRight).toHaveScreenshot('terminal-action-buttons.png');
  });
  /**
   ...
   */
  (0, test_1.test)('should render new terminal button hover state @P2', async ({ page }) => {
    // Hover over new terminal button
    const newTerminalBtn = page.locator('#btn-new-terminal');
    await newTerminalBtn.hover();
    // Assert: Visual comparison
    await (0, test_1.expect)(newTerminalBtn).toHaveScreenshot('terminal-btn-new-hover.png');
  });
  /**
   ...
   */
  (0, test_1.test)('should render split terminal button hover state @P2', async ({ page }) => {
    // Hover over split button
    const splitBtn = page.locator('#btn-split-terminal');
    await splitBtn.hover();
    // Assert: Visual comparison
    await (0, test_1.expect)(splitBtn).toHaveScreenshot('terminal-btn-split-hover.png');
  });
});
/**
 ...
 */
test_1.test.describe('Agent Status Indicator @visual-regression', () => {
  let vrtHelper;
  test_1.test.beforeEach(async ({ page }) => {
    vrtHelper = new helpers_1.VRTHelper(page);
    await page.goto('/standalone-webview.html');
   ...
   */
  (0, test_1.test)('should render Claude Code agent status correctly @P1', async ({ page }) => {
    ...
    await (0, test_1.expect)(agentStatus).toHaveScreenshot('agent-status-claude.png');
  });
  /**
   ...
   */
  (0, test_1.test)('should render GitHub Copilot agent status correctly @P1', async ({ page }) => {
    ...
    // Assert: Visual comparison
    const agentStatus = page.locator('#agent-status');
    await (0, test_1.expect)(agentStatus).toHaveScreenshot('agent-status-copilot.png');
  });
  /**
   ...
   */
  (0, test_1.test)('should render Gemini CLI agent status correctly @P1', async ({ page }) => {
    ...
    // Assert: Visual comparison
    const agentStatus = page.locator('#agent-status');
    await (0, test_1.expect)(agentStatus).toHaveScreenshot('agent-status-gemini.png');
  });
  /**
   ...
   */
  (0, test_1.test)('should hide agent status when no agent detected @P2', async ({ page }) => {
...
//# sourceMappingURL=terminal-layout.spec.js.map
