...
exports.window = {
  ...
  withProgress: vitest_1.vi
    .fn()
    .mockImplementation((_options, task) => task({ report: vitest_1.vi.fn() })),
...
exports.debug = {
  ...
  registerDebugConfigurationProvider: vitest_1.vi
    .fn()
    .mockReturnValue({ dispose: vitest_1.vi.fn() }),
