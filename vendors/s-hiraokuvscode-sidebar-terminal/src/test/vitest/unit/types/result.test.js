...
(0, vitest_1.describe)('success', () => {
  ...
  (0, vitest_1.it)('should handle various value types', () => {
    (0, vitest_1.expect)((0, result_1.success)('string')).toEqual({
      success: true,
      value: 'string',
    });
    (0, vitest_1.expect)((0, result_1.success)({ a: 1 })).toEqual({
      success: true,
      value: { a: 1 },
    });
    (0, vitest_1.expect)((0, result_1.success)([1, 2, 3])).toEqual({
      success: true,
      value: [1, 2, 3],
    });
    (0, vitest_1.expect)((0, result_1.success)(null)).toEqual({ success: true, value: null });
    (0, vitest_1.expect)((0, result_1.success)(undefined)).toEqual({
      success: true,
      value: undefined,
    });
  });
...
(0, vitest_1.describe)('failureFromError', () => {
  ...
  (0, vitest_1.it)('should include context', () => {
    ...
    const result = (0, result_1.failureFromError)(
      originalError,
      result_1.ErrorCode.NETWORK_ERROR,
      context
    );
    const error = result.error;
    (0, vitest_1.expect)(error.context).toEqual(context);
...
(0, vitest_1.describe)('chain', () => {
  ...
  (0, vitest_1.it)('should return failure from chained function', () => {
    const result = (0, result_1.success)(42);
    const chained = (0, result_1.chain)(result, () =>
      (0, result_1.failure)(new Error('Chain error'))
    );
    (0, vitest_1.expect)((0, result_1.isFailure)(chained)).toBe(true);
  });
});
...
(0, vitest_1.describe)('all', () => {
  ...
  (0, vitest_1.it)('should return first failure when any result fails', () => {
    const error = new Error('Error');
    const results = [
      (0, result_1.success)(1),
      (0, result_1.failure)(error),
      (0, result_1.success)(3),
    ];
    const combined = (0, result_1.all)(results);
...
(0, vitest_1.describe)('ErrorCode', () => {
  (0, vitest_1.it)('should have all expected error codes', () => {
    ...
    (0, vitest_1.expect)(result_1.ErrorCode.TERMINAL_CREATION_FAILED).toBe(
      'TERMINAL_CREATION_FAILED'
    );
    (0, vitest_1.expect)(result_1.ErrorCode.TERMINAL_PROCESS_FAILED).toBe(
      'TERMINAL_PROCESS_FAILED'
    );
    (0, vitest_1.expect)(result_1.ErrorCode.TERMINAL_ALREADY_EXISTS).toBe(
    ...
    (0, vitest_1.expect)(result_1.ErrorCode.IPC_COMMUNICATION_FAILED).toBe(
      'IPC_COMMUNICATION_FAILED'
    );
    (0, vitest_1.expect)(result_1.ErrorCode.INVALID_STATE).toBe('INVALID_STATE');
    (0, vitest_1.expect)(result_1.ErrorCode.STATE_TRANSITION_FAILED).toBe(
    ...
    (0, vitest_1.expect)(result_1.ErrorCode.PERSISTENCE_LOAD_FAILED).toBe(
      'PERSISTENCE_LOAD_FAILED'
    );
    (0, vitest_1.expect)(result_1.ErrorCode.PERSISTENCE_SAVE_FAILED).toBe(
    ...
    (0, vitest_1.expect)(result_1.ErrorCode.CLI_AGENT_CONNECTION_FAILED).toBe(
      'CLI_AGENT_CONNECTION_FAILED'
    );
