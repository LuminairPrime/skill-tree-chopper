...
(0, vitest_1.describe)('SessionDataTransformer', () => {
    ...
    (0, vitest_1.describe)('Validation', () => {
        (0, vitest_1.it)('should identify valid session data', () => {
            (0, vitest_1.expect)(session_types_1.SessionDataTransformer.isValidSessionData(validSession)).toBe(true);
        });
        (0, vitest_1.it)('should reject invalid structures', () => {
            (0, vitest_1.expect)(session_types_1.SessionDataTransformer.isValidSessionData({})).toBe(false);
            (0, vitest_1.expect)(session_types_1.SessionDataTransformer.isValidSessionData({ terminals: [] })).toBe(false); // missing timestamp/version
        });
    });
    (0, vitest_1.describe)('Expiry', () => {
        (0, vitest_1.it)('should detect expired sessions', () => {
            ...
            (0, vitest_1.expect)(session_types_1.SessionDataTransformer.isSessionExpired(oldSession, 7)).toBe(true);
        });
        (0, vitest_1.it)('should not detect fresh sessions as expired', () => {
            (0, vitest_1.expect)(session_types_1.SessionDataTransformer.isSessionExpired(validSession, 7)).toBe(false);
        });
    });
    (0, vitest_1.describe)('Storage Optimization', () => {
        ...
        (0, vitest_1.it)('should detect when storage limit is exceeded', () => {
            ...
            const result = session_types_1.SessionDataTransformer.isStorageLimitExceeded(validSession, 0.000001); // ultra-low limit
        ...
        (0, vitest_1.it)('should optimize storage by trimming scrollback', () => {
            ...
            const result = session_types_1.SessionDataTransformer.optimizeSessionStorage(sessionWithLargeScrollback, 0.0001); // Trigger optimization
