...
(0, vitest_1.describe)('LazyInitializable', () => {
    ...
    (0, vitest_1.it)('should start in UNINITIALIZED state', () => {
        (0, vitest_1.expect)(testObj.initializationState).toBe(LazyInitializable_1.InitializationState.UNINITIALIZED);
    ...
    (0, vitest_1.describe)('ensureInitialized (Sync)', () => {
        ...
        (0, vitest_1.it)('should throw InitializationError if doInitialize throws', () => {
            ...
            (0, vitest_1.expect)(() => testObj.publicEnsureInitialized()).toThrow(LazyInitializable_1.InitializationError);
            (0, vitest_1.expect)(testObj.initializationState).toBe(LazyInitializable_1.InitializationState.FAILED);
        });
    });
    (0, vitest_1.describe)('ensureInitializedAsync', () => {
        ...
        (0, vitest_1.it)('should throw InitializationError if async initialization fails', async () => {
            ...
            await (0, vitest_1.expect)(testObj.publicEnsureInitializedAsync()).rejects.toThrow(LazyInitializable_1.InitializationError);
            (0, vitest_1.expect)(testObj.initializationState).toBe(LazyInitializable_1.InitializationState.FAILED);
        });
    });
