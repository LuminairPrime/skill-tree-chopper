...
(0, vitest_1.describe)('TerminalManager - Memory Leak Detection', () => {
  ...
  (0, vitest_1.it)(
    'should not leak memory when creating and disposing TerminalManager',
    async () => {
  ...
  (0, vitest_1.it)(
    'should clean up PTY data disposables when disposing',
    async () => {
      terminalManager = new TerminalManager_1.TerminalManager();
  ...
  (0, vitest_1.it)(
    'should clean up timers when disposing',
    async () => {
      terminalManager = new TerminalManager_1.TerminalManager();
  ...
  (0, vitest_1.it)(
    'should handle rapid create/dispose cycles without leaking',
    async () => {
      const detector = new MemoryLeakDetector_1.MemoryLeakDetector();
      await detector.startMonitoring();
