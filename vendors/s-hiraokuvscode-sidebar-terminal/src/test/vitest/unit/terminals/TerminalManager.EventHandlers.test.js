...
(0, vitest_1.describe)('TerminalManager - Event Handler Setup (TDD)', () => {
  ...
  (0, vitest_1.describe)('RED Phase: Event Handler Duplication Detection', () => {
    ...
    (0, vitest_1.it)(
      'should register onData handler exactly once in createTerminalWithProfile()',
      async () => {
    ...
    (0, vitest_1.it)(
      'should register onExit handler exactly once in createTerminalWithProfile()',
      async () => {
        // Act: Create terminal with profile
        const terminalId = await terminalManager.createTerminalWithProfile();
        // Assert: Only one exit handler should be registered
  ...
  (0, vitest_1.describe)('REFACTOR Phase: Method Consistency', () => {
    (0, vitest_1.it)(
      'should use identical event setup pattern in both create methods',
      async () => {
  ...
  (0, vitest_1.describe)('REFACTOR Phase: Edge Cases', () => {
    ...
    (0, vitest_1.it)(
      'should not register duplicate handlers on multiple state transitions',
      async () => {
        const terminalId = terminalManager.createTerminal();
...
(0, vitest_1.describe)('TerminalManager - Event Handler Cross-Contamination Prevention', () => {
  ...
  (0, vitest_1.beforeEach)(async () => {
    ...
    let callCount = 0;
    spawnStub = vitest_1.vi
      .spyOn(TerminalSpawner.prototype, 'spawnTerminal')
      .mockImplementation(() => {
        callCount++;
