...
(0, vitest_1.describe)('TerminalSpawner', () => {
    ...
    (0, vitest_1.describe)('spawnTerminal', () => {
        (0, vitest_1.it)('should spawn a terminal with provided configuration', () => {
            ...
            (0, vitest_1.expect)(pty.spawn).toHaveBeenCalledWith(defaultRequest.shell, defaultRequest.shellArgs, vitest_1.expect.objectContaining({
        ...
        (0, vitest_1.it)('should try fallback shells if primary shell fails', () => {
            ...
            (0, vitest_1.expect)(['/bin/zsh', '/bin/bash', '/bin/sh']).toContain(vitest_1.vi.mocked(pty.spawn).mock.calls[1][0]);
            (0, vitest_1.expect)(result.ptyProcess).toBe(mockPtyProcess);
        });
        (0, vitest_1.it)('should skip inaccessible directories', () => {
            ...
            (0, vitest_1.expect)(pty.spawn).toHaveBeenCalledWith(vitest_1.expect.any(String), vitest_1.expect.any(Array), vitest_1.expect.objectContaining({
