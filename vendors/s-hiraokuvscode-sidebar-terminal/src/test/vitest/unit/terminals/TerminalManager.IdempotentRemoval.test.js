...
(0, vitest_1.describe)('TerminalManager - Idempotent Removal', () => {
    ...
    (0, vitest_1.it)('should fire terminalRemoved event exactly once even if _performCleanup is called multiple times', async () => {
    ...
    (0, vitest_1.it)('should only fire exit event once if cleanup is already in progress', async () => {
