...
(0, vitest_1.describe)('TerminalProcessCoordinator', () => {
  ...
  beforeEach(() => {
    ...
    coordinator = new TerminalProcessCoordinator_1.TerminalProcessCoordinator(
      mockTerminals,
      mockShellIntegrationService,
  ...
  (0, vitest_1.describe)('initializeShellForTerminal', () => {
    (0, vitest_1.it)('should inject shell integration if enabled and not safe mode', () => {
      ...
      (0, vitest_1.expect)(mockShellIntegrationService.injectShellIntegration).toHaveBeenCalledWith(
        't1',
        '/bin/bash',
        mockPtyProcess
      );
    ...
    (0, vitest_1.it)('should skip shell integration in safe mode', () => {
      ...
      (0, vitest_1.expect)(
        mockShellIntegrationService.injectShellIntegration
  ...
  (0, vitest_1.describe)('notifyProcessStateChange', () => {
    (0, vitest_1.it)('should fire event emitter', () => {
      ...
      (0, vitest_1.expect)(mockStateUpdateEmitter.fire).toHaveBeenCalledWith(
