...
(0, vitest_1.describe)('ConsolidatedMessageManager', () => {
    ...
    (0, vitest_1.describe)('IMessageManager Interface', () => {
        ...
        (0, vitest_1.it)('should implement emitTerminalInteractionEvent', () => {
            ...
            (0, vitest_1.expect)(() => messageManager.emitTerminalInteractionEvent('focus', 'terminal-1', { text: 'test' }, mockCoordinator)).not.toThrow();
            // Messages are sent immediately when vscode API is available
            const stats = messageManager.getQueueStats();
            (0, vitest_1.expect)(stats.queueSize).toBeGreaterThanOrEqual(0);
        });
        ...
        (0, vitest_1.it)('should implement sendInput', () => {
            ...
            (0, vitest_1.expect)(() => messageManager.sendInput('test input', 'terminal-1')).not.toThrow();
            // Messages are sent immediately when vscode API is available
            const stats = messageManager.getQueueStats();
            (0, vitest_1.expect)(stats.queueSize).toBeGreaterThanOrEqual(0);
        });
        ...
        (0, vitest_1.it)('should implement sendDeleteTerminalMessage', () => {
            ...
            (0, vitest_1.expect)(() => messageManager.sendDeleteTerminalMessage('terminal-1', 'header', mockCoordinator)).not.toThrow();
            // Messages are sent immediately when vscode API is available
            const stats = messageManager.getQueueStats();
            (0, vitest_1.expect)(stats.queueSize).toBeGreaterThanOrEqual(0);
        });
    ...
    (0, vitest_1.describe)('Disposal', () => {
        ...
        (0, vitest_1.it)('should clear handlers on dispose', () => {
            ...
            const newManager = new ConsolidatedMessageManager_1.ConsolidatedMessageManager(mockCoordinator);
    ...
    (0, vitest_1.describe)('Error Handling', () => {
        ...
        (0, vitest_1.it)('should handle coordinator not available error', async () => {
            const manager = new ConsolidatedMessageManager_1.ConsolidatedMessageManager();
            await (0, vitest_1.expect)(manager.sendToExtension({ command: 'test' })).rejects.toThrow('Coordinator not available');
            manager.dispose();
        });
    });
    ...
    (0, vitest_1.describe)('Session restore resizer handling', () => {
        (0, vitest_1.it)('should recover split resizers on sessionRestored message in split mode', async () => {
        ...
        (0, vitest_1.it)('should recover split resizers when snapshot is stale but split wrappers exist', async () => {
            const updateSplitResizers = vitest_1.vi.fn();
            const showAllTerminalsSplit = vitest_1.vi.fn();
            const getDisplayModeManager = () => ({
                getCurrentMode: () => 'split',
        ...
        (0, vitest_1.it)('should call updateSplitResizers after session restore in split mode with multiple terminals', async () => {
            const updateSplitResizers = vitest_1.vi.fn();
            const showAllTerminalsSplit = vitest_1.vi.fn();
            const getDisplayModeManager = () => ({
                getCurrentMode: () => 'split',
        ...
        (0, vitest_1.it)('should not call updateSplitResizers after session restore in normal mode', async () => {
            const updateSplitResizers = vitest_1.vi.fn();
            const getDisplayModeManager = () => ({
        ...
        (0, vitest_1.it)('should not call updateSplitResizers when only one terminal is visible in split mode', async () => {
            const updateSplitResizers = vitest_1.vi.fn();
            const getDisplayModeManager = () => ({
                getCurrentMode: () => 'split',
            });
        ...
        (0, vitest_1.it)('should recover split resizers when split wrappers appear after delayed session restore rendering', async () => {
