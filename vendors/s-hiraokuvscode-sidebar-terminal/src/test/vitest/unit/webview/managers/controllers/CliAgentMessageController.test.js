...
(0, vitest_1.describe)('CliAgentMessageController', () => {
    ...
    (0, vitest_1.describe)('handleStatusUpdateMessage', () => {
        (0, vitest_1.it)('should log warning if no cliAgentStatus is present', () => {
            ...
            (0, vitest_1.expect)(mockLogger.warn).toHaveBeenCalledWith('No CLI Agent status data in message');
        });
        (0, vitest_1.it)('should update status using provided terminalId', () => {
            ...
            controller.handleStatusUpdateMessage(msg, mockCoordinator);
            (0, vitest_1.expect)(mockCoordinator.updateCliAgentStatus).toHaveBeenCalledWith('term-1', 'connected', null);
            (0, vitest_1.expect)(mockLogger.info).toHaveBeenCalledWith(vitest_1.expect.stringContaining('CLI Agent status updated successfully'));
        });
        (0, vitest_1.it)('should extract terminalId from activeTerminalName if terminalId missing', () => {
            const msg = {
                command: 'statusUpdate',
                // @ts-expect-error - test mock type
                cliAgentStatus: {
            ...
            controller.handleStatusUpdateMessage(msg, mockCoordinator);
            (0, vitest_1.expect)(mockCoordinator.updateCliAgentStatus).toHaveBeenCalledWith('2', 'connected', null);
        });
        (0, vitest_1.it)('should use fallback terminalId if neither ID nor name allows extraction', () => {
            ...
            controller.handleStatusUpdateMessage(msg, mockCoordinator);
            (0, vitest_1.expect)(mockCoordinator.updateCliAgentStatus).toHaveBeenCalledWith('term-1', // fallback from mockCoordinator.getAllTerminalInstances().keys()[0]
            'connected', null);
            (0, vitest_1.expect)(mockLogger.warn).toHaveBeenCalledWith(vitest_1.expect.stringContaining('Using fallback terminalId'));
        });
        (0, vitest_1.it)('should map legacy status correctly', () => {
            ...
            statuses.forEach(({ input, expected }) => {
                ...
                controller.handleStatusUpdateMessage(msg, mockCoordinator);
                (0, vitest_1.expect)(mockCoordinator.updateCliAgentStatus).toHaveBeenCalledWith('term-1', expected, null);
            });
        });
        (0, vitest_1.it)('should handle errors gracefully', () => {
            ...
            controller.handleStatusUpdateMessage(msg, mockCoordinator);
            (0, vitest_1.expect)(mockLogger.error).toHaveBeenCalledWith('Error updating CLI Agent status', error);
        });
    });
    (0, vitest_1.describe)('handleFullStateSyncMessage', () => {
        (0, vitest_1.it)('should log warning if no terminalStates data', () => {
            ...
            (0, vitest_1.expect)(mockLogger.warn).toHaveBeenCalledWith('No terminal states data in full state sync message');
        });
        (0, vitest_1.it)('should update multiple terminals', () => {
            ...
            controller.handleFullStateSyncMessage(msg, mockCoordinator);
            (0, vitest_1.expect)(mockCoordinator.updateCliAgentStatus).toHaveBeenCalledWith('term-1', 'connected', 'claude');
            (0, vitest_1.expect)(mockCoordinator.updateCliAgentStatus).toHaveBeenCalledWith('term-2', 'disconnected', null);
            (0, vitest_1.expect)(mockLogger.info).toHaveBeenCalledWith('Full CLI Agent state sync completed successfully');
        });
        (0, vitest_1.it)('should continue processing other terminals if one fails', () => {
            ...
            controller.handleFullStateSyncMessage(msg, mockCoordinator);
            (0, vitest_1.expect)(mockLogger.error).toHaveBeenCalledWith('Error updating terminal term-1', error);
            (0, vitest_1.expect)(mockCoordinator.updateCliAgentStatus).toHaveBeenCalledWith('term-2', 'disconnected', null);
        });
    });
    (0, vitest_1.describe)('handleSwitchResponseMessage', () => {
        (0, vitest_1.it)('should warn if notification manager is missing', () => {
            ...
            (0, vitest_1.expect)(mockLogger.warn).toHaveBeenCalledWith('NotificationManager not available for AI Agent feedback');
        });
        (0, vitest_1.it)('should show success notification on forced reconnect', () => {
            ...
            controller.handleSwitchResponseMessage(msg, mockCoordinator);
            (0, vitest_1.expect)(mockNotificationManager.showNotificationInTerminal).toHaveBeenCalledWith('📎 AI Agent Connected', 'success');
            (0, vitest_1.expect)(mockLogger.info).toHaveBeenCalledWith('AI Agent operation succeeded', vitest_1.expect.anything());
        });
        (0, vitest_1.it)('should show error notification on failure', () => {
            ...
            controller.handleSwitchResponseMessage(msg, mockCoordinator);
            (0, vitest_1.expect)(mockNotificationManager.showNotificationInTerminal).toHaveBeenCalledWith('❌ AI Agent operation failed', 'error');
            (0, vitest_1.expect)(mockLogger.error).toHaveBeenCalledWith('AI Agent operation failed', vitest_1.expect.anything());
        });
    });
});
