...
(0, vitest_1.describe)('SplitLayoutService - Grid Layout', () => {
    ...
    (0, vitest_1.describe)('activateGridLayout', () => {
        ...
        (0, vitest_1.it)('should place the 6th terminal on second row spanning full width in 2x5 mode', () => {
            const containers = createContainers(6);
            service.activateGridLayout(terminalBody, getTerminalIds(6), (id) => containers.get(id));
        ...
        (0, vitest_1.it)('should force inline display:grid on terminals-wrapper when activating grid', () => {
    ...
    (0, vitest_1.describe)('Grid → Flex transition', () => {
        (0, vitest_1.it)('should cleanly transition from grid to flex when removeSplitArtifacts is called', () => {
            const containers = createContainers(6);
            service.activateGridLayout(terminalBody, getTerminalIds(6), (id) => containers.get(id));
            (0, vitest_1.expect)(service.isGridMode()).toBe(true);
            ...
            (0, vitest_1.expect)(document.querySelectorAll('[data-terminal-wrapper-id]').length).toBe(0);
        });
    });
