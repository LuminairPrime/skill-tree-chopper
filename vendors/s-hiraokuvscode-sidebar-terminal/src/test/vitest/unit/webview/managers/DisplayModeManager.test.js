...
(0, vitest_1.describe)('DisplayModeManager - Fullscreen Display (Issue #198)', () => {
    ...
    (0, vitest_1.beforeEach)(() => {
        ...
        mockContainerManager = {
            ...
            getAllContainers: vitest_1.vi.fn().mockReturnValue(new Map([
    ...
    (0, vitest_1.describe)('Fullscreen Mode', () => {
        (0, vitest_1.it)('should switch to fullscreen mode when showTerminalFullscreen is called', () => {
            // Act
    ...
    (0, vitest_1.describe)('Mode Transitions', () => {
        ...
        (0, vitest_1.it)('should clear container height styles when entering horizontal split from fullscreen', () => {
            ...
            containers.forEach((container) => {
                (0, vitest_1.expect)(DOMUtils_1.DOMUtils.clearContainerHeightStyles).toHaveBeenCalledWith(container);
            });
        });
        ...
        (0, vitest_1.it)('should schedule multiple refits in grid mode to avoid header-only rendering', () => {
    ...
    (0, vitest_1.describe)('Cleanup', () => {
        (0, vitest_1.it)('should call showAllTerminals on dispose', () => {
            ...
            (0, vitest_1.expect)(mockContainerManager.applyDisplayState.mock.calls.length).toBeGreaterThan(callCountBefore);
        });
