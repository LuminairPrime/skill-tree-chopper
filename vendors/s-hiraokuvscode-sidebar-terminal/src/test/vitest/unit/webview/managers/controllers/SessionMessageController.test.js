...
(0, vitest_1.describe)('SessionMessageController', () => {
    ...
    (0, vitest_1.describe)('handleSessionRestoreMessage', () => {
        (0, vitest_1.it)('should log error if terminalId or terminalName is missing', async () => {
            ...
            (0, vitest_1.expect)(mockLogger.error).toHaveBeenCalledWith('Invalid session restore data received', vitest_1.expect.anything());
        });
        (0, vitest_1.it)('should use restoreSession if available on coordinator', async () => {
            ...
            (0, vitest_1.expect)(mockLogger.info).toHaveBeenCalledWith(vitest_1.expect.stringContaining('Successfully restored terminal session'));
        });
        (0, vitest_1.it)('should fallback to createTerminal if restoreSession returns false', async () => {
            const msg = {
                command: 'sessionRestore',
                terminalId: 'term-1',
                terminalName: 'Term 1',
            ...
            mockCoordinator.restoreSession = restoreSessionMock;
            await controller.handleSessionRestoreMessage(msg, mockCoordinator);
            (0, vitest_1.expect)(mockLogger.warn).toHaveBeenCalledWith(vitest_1.expect.stringContaining('Session restore failed'));
            (0, vitest_1.expect)(mockCoordinator.createTerminal).toHaveBeenCalledWith('term-1', 'Term 1', { shell: 'bash' }, undefined, 'extension');
        });
        (0, vitest_1.it)('should use createTerminal if restoreSession is not available', async () => {
            ...
            await controller.handleSessionRestoreMessage(msg, mockCoordinator);
            (0, vitest_1.expect)(mockCoordinator.createTerminal).toHaveBeenCalledWith('term-1', 'Term 1', { shell: 'zsh' }, undefined, 'extension');
        });
        (0, vitest_1.it)('should call restoreTerminalScrollback if message/scrollback exists and createTerminal was used', async () => {
            ...
            (0, vitest_1.expect)(restoreTerminalScrollbackMock).toHaveBeenCalledWith('term-1', 'Restored', []);
            vitest_1.vi.useRealTimers();
        });
        (0, vitest_1.it)('should handle errors during creation and try creation again as fallback', async () => {
            const msg = {
                command: 'sessionRestore',
                terminalId: 'term-1',
                terminalName: 'Term 1',
            ...
            await controller.handleSessionRestoreMessage(msg, mockCoordinator);
            (0, vitest_1.expect)(mockLogger.error).toHaveBeenCalledWith(vitest_1.expect.stringContaining('Failed to restore terminal session'));
    ...
    (0, vitest_1.describe)('Notification handlers', () => {
        ...
        (0, vitest_1.it)('handleSessionRestoreCompletedMessage should call notification util', () => {
            ...
            (0, vitest_1.expect)(NotificationUtils.showSessionRestoreCompleted).toHaveBeenCalledWith(3, 2);
        });
        (0, vitest_1.it)('handleSessionRestoreErrorMessage should call notification util', () => {
            ...
            (0, vitest_1.expect)(NotificationUtils.showSessionRestoreError).toHaveBeenCalledWith('Fail', true, 'Timeout');
        });
        ...
        (0, vitest_1.it)('handleSessionSaveErrorMessage should call notification util', () => {
            ...
            (0, vitest_1.expect)(NotificationUtils.showSessionSaveError).toHaveBeenCalledWith('Disk full');
        });
        ...
        (0, vitest_1.it)('handleTerminalRestoreErrorMessage should call notification util dynamically imported', async () => {
            ...
            const { showTerminalRestoreError } = await Promise.resolve().then(() => require('../../../../../../webview/utils/NotificationUtils'));
    ...
    (0, vitest_1.describe)('handleSessionRestoredMessage', () => {
        (0, vitest_1.it)('should log success message', () => {
            ...
            (0, vitest_1.expect)(mockLogger.info).toHaveBeenCalledWith(vitest_1.expect.stringContaining('Session restoration successful'));
        });
        (0, vitest_1.it)('should log warning message for partial success', () => {
            ...
            (0, vitest_1.expect)(mockLogger.warn).toHaveBeenCalledWith(vitest_1.expect.stringContaining('Session restoration partially failed'));
        });
    });
});
