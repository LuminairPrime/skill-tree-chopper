...
(0, vitest_1.describe)('CommandRegistry', () => {
  ...
  (0, vitest_1.describe)('dispatch', () => {
    ...
    (0, vitest_1.it)(
      'should continue execution when handler fails with continueOnError',
      async () => {
...
(0, vitest_1.describe)('createLoggingMiddleware', () => {
  ...
  (0, vitest_1.it)('should log command execution', async () => {
    ...
    (0, vitest_1.expect)(mockLogger).toHaveBeenCalledWith(
      vitest_1.expect.stringContaining('→ testCommand')
    );
    (0, vitest_1.expect)(mockLogger).toHaveBeenCalledWith(
      vitest_1.expect.stringContaining('✅ testCommand')
    );
...
(0, vitest_1.describe)('createPerformanceMiddleware', () => {
  ...
  (0, vitest_1.it)('should not log for fast commands (under threshold)', async () => {
    const { webview: mockLog } = await Promise.resolve().then(() =>
    ...
    const slowWarningCalls = mockLog.mock.calls.filter((call) =>
  ...
  (0, vitest_1.it)('should log warning for slow commands (over threshold)', async () => {
    ...
    (0, vitest_1.expect)(mockLog).toHaveBeenCalledWith(
      vitest_1.expect.stringContaining('⚠️ Slow command: slowCommand')
    );
  });
  (0, vitest_1.it)('should use custom threshold', async () => {
    ...
    (0, vitest_1.expect)(mockLog).toHaveBeenCalledWith(
      vitest_1.expect.stringContaining('⚠️ Slow command: mediumCommand')
    );
  });
