...
(0, vitest_1.describe)('NotificationBridge', () => {
    ...
    (0, vitest_1.describe)('Specialized Notification Methods', () => {
        ...
        (0, vitest_1.it)('should show terminal close error', () => {
            ...
            (0, vitest_1.expect)(mockNotificationSystem.notify).toHaveBeenCalledWith(vitest_1.expect.objectContaining({
                type: 'warning',
...
(0, vitest_1.describe)('Notification Duration Constants', () => {
    ...
    (0, vitest_1.it)('should use 6000ms for CLI agent detected', () => {
        bridge.showCliAgentDetected();
        (0, vitest_1.expect)(mockNotificationSystem.notify).toHaveBeenCalledWith(vitest_1.expect.objectContaining({ duration: 6000 }));
    });
    (0, vitest_1.it)('should use 3000ms for CLI agent ended', () => {
        bridge.showCliAgentEnded();
        (0, vitest_1.expect)(mockNotificationSystem.notify).toHaveBeenCalledWith(vitest_1.expect.objectContaining({ duration: 3000 }));
    });
    (0, vitest_1.it)('should use 4000ms for Alt+Click disabled', () => {
        bridge.showAltClickDisabledWarning();
        (0, vitest_1.expect)(mockNotificationSystem.notify).toHaveBeenCalledWith(vitest_1.expect.objectContaining({ duration: 4000 }));
    });
    ...
    (0, vitest_1.it)('should use 5000ms for terminal interaction issue', () => {
        ...
        (0, vitest_1.expect)(mockNotificationSystem.notify).toHaveBeenCalledWith(vitest_1.expect.objectContaining({ duration: 5000 }));
    });
});
