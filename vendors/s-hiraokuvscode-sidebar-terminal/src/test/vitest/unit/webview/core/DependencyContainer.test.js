...
(0, vitest_1.describe)('DependencyContainer', () => {
    ...
    (0, vitest_1.describe)('register', () => {
        (0, vitest_1.it)('should register a service with factory', () => {
            ...
            (0, vitest_1.expect)(container.isRegistered(DependencyContainer_1.ServiceType.UI_MANAGER)).toBe(true);
        });
        ...
        (0, vitest_1.it)('should register service with dependencies', () => {
            ...
            (0, vitest_1.expect)(graph.get(DependencyContainer_1.ServiceType.UI_MANAGER)).toContain(DependencyContainer_1.ServiceType.SETTINGS_COORDINATOR);
        });
    });
    (0, vitest_1.describe)('registerInstance', () => {
        (0, vitest_1.it)('should register an existing instance', () => {
            ...
            (0, vitest_1.expect)(container.isRegistered(DependencyContainer_1.ServiceType.UI_MANAGER)).toBe(true);
            (0, vitest_1.expect)(container.isResolved(DependencyContainer_1.ServiceType.UI_MANAGER)).toBe(true);
        });
    ...
    (0, vitest_1.describe)('resolve', () => {
        ...
        (0, vitest_1.it)('should throw for unregistered service', async () => {
            await (0, vitest_1.expect)(container.resolve(DependencyContainer_1.ServiceType.UI_MANAGER)).rejects.toThrow('Service ui_manager is not registered');
        });
        ...
        (0, vitest_1.it)('should throw when resolving during disposal', async () => {
            ...
            await (0, vitest_1.expect)(container.resolve(DependencyContainer_1.ServiceType.UI_MANAGER)).rejects.toThrow('Container is disposing, cannot resolve services');
        });
    ...
    (0, vitest_1.describe)('isRegistered', () => {
        ...
        (0, vitest_1.it)('should return false for unregistered service', () => {
            (0, vitest_1.expect)(container.isRegistered(DependencyContainer_1.ServiceType.UI_MANAGER)).toBe(false);
        });
    });
    (0, vitest_1.describe)('isResolved', () => {
        ...
        (0, vitest_1.it)('should return false for registered but not resolved service', () => {
            container.register(DependencyContainer_1.ServiceType.UI_MANAGER, () => createMockService());
            (0, vitest_1.expect)(container.isResolved(DependencyContainer_1.ServiceType.UI_MANAGER)).toBe(false);
        });
        (0, vitest_1.it)('should return false for unregistered service', () => {
            (0, vitest_1.expect)(container.isResolved(DependencyContainer_1.ServiceType.UI_MANAGER)).toBe(false);
        });
    ...
    (0, vitest_1.describe)('getResolvedServices', () => {
        (0, vitest_1.it)('should return all resolved services', async () => {
            container.register(DependencyContainer_1.ServiceType.UI_MANAGER, () => createMockService());
            container.register(DependencyContainer_1.ServiceType.INPUT_MANAGER, () => createMockService());
            await container.resolve(DependencyContainer_1.ServiceType.UI_MANAGER);
            ...
            (0, vitest_1.expect)(resolved.has(DependencyContainer_1.ServiceType.INPUT_MANAGER)).toBe(false);
        });
    ...
    (0, vitest_1.describe)('getServiceHealth', () => {
        (0, vitest_1.it)('should return health status for all registered services', async () => {
            ...
            (0, vitest_1.expect)(health.get(DependencyContainer_1.ServiceType.UI_MANAGER)?.lifecycle).toBe(DependencyContainer_1.ServiceLifecycle.INITIALIZED);
            (0, vitest_1.expect)(health.get(DependencyContainer_1.ServiceType.INPUT_MANAGER)?.lifecycle).toBe(DependencyContainer_1.ServiceLifecycle.REGISTERED);
        });
        (0, vitest_1.it)('should include error message for failed services', async () => {
            ...
            const health = container.getServiceHealth();
            (0, vitest_1.expect)(health.get(DependencyContainer_1.ServiceType.UI_MANAGER)?.lifecycle).toBe(DependencyContainer_1.ServiceLifecycle.ERROR);
            (0, vitest_1.expect)(health.get(DependencyContainer_1.ServiceType.UI_MANAGER)?.error).toBe('Initialization failed');
        });
    });
    (0, vitest_1.describe)('getDependencyGraph', () => {
        (0, vitest_1.it)('should return complete dependency graph', () => {
            container.register(DependencyContainer_1.ServiceType.SETTINGS_COORDINATOR, () => createSimpleService());
            container.register(DependencyContainer_1.ServiceType.UI_MANAGER, () => createSimpleService(), [
                DependencyContainer_1.ServiceType.SETTINGS_COORDINATOR,
            ]);
            container.register(DependencyContainer_1.ServiceType.INPUT_MANAGER, () => createSimpleService(), [
                DependencyContainer_1.ServiceType.UI_MANAGER,
                DependencyContainer_1.ServiceType.SETTINGS_COORDINATOR,
            ]);
            const graph = container.getDependencyGraph();
            (0, vitest_1.expect)(graph.get(DependencyContainer_1.ServiceType.SETTINGS_COORDINATOR)).toEqual([]);
            (0, vitest_1.expect)(graph.get(DependencyContainer_1.ServiceType.UI_MANAGER)).toEqual([DependencyContainer_1.ServiceType.SETTINGS_COORDINATOR]);
            (0, vitest_1.expect)(graph.get(DependencyContainer_1.ServiceType.INPUT_MANAGER)).toContain(DependencyContainer_1.ServiceType.UI_MANAGER);
            (0, vitest_1.expect)(graph.get(DependencyContainer_1.ServiceType.INPUT_MANAGER)).toContain(DependencyContainer_1.ServiceType.SETTINGS_COORDINATOR);
        });
    });
    (0, vitest_1.describe)('validateDependencyGraph', () => {
        ...
        (0, vitest_1.it)('should detect complex circular chains', () => {
            ...
            container.register(DependencyContainer_1.ServiceType.CONFIG_MANAGER, () => createSimpleService(), [
                DependencyContainer_1.ServiceType.UI_MANAGER,
            ]);
            const result = container.validateDependencyGraph();
            (0, vitest_1.expect)(result.isValid).toBe(false);
    ...
    (0, vitest_1.describe)('dispose', () => {
        (0, vitest_1.it)('should dispose all resolved services', async () => {
            ...
            container.register(DependencyContainer_1.ServiceType.UI_MANAGER, () => createMockService({ disposeImpl: disposeFn1 }));
            container.register(DependencyContainer_1.ServiceType.INPUT_MANAGER, () => createMockService({ disposeImpl: disposeFn2 }));
            await container.resolve(DependencyContainer_1.ServiceType.UI_MANAGER);
        ...
        (0, vitest_1.it)('should dispose in reverse initialization order (LIFO)', async () => {
            const order = [];
            container.register(DependencyContainer_1.ServiceType.SETTINGS_COORDINATOR, () => createMockService({
        ...
        (0, vitest_1.it)('should handle multiple dispose calls gracefully', async () => {
            ...
            container.register(DependencyContainer_1.ServiceType.UI_MANAGER, () => createMockService({ disposeImpl: disposeFn }));
            await container.resolve(DependencyContainer_1.ServiceType.UI_MANAGER);
            await container.dispose();
            await container.dispose();
        ...
        (0, vitest_1.it)('should not dispose services without IEnhancedBaseManager interface', async () => {
    ...
    (0, vitest_1.describe)('createScope', () => {
        (0, vitest_1.it)('should create a new container with copied registrations', () => {
            ...
            (0, vitest_1.expect)(scope.isRegistered(DependencyContainer_1.ServiceType.UI_MANAGER)).toBe(true);
            (0, vitest_1.expect)(scope.isRegistered(DependencyContainer_1.ServiceType.INPUT_MANAGER)).toBe(true);
        });
    ...
    (0, vitest_1.describe)('IEnhancedBaseManager initialization', () => {
        ...
        (0, vitest_1.it)('should pass resolved dependencies to initialize', async () => {
            ...
            container.register(DependencyContainer_1.ServiceType.SETTINGS_COORDINATOR, () => settingsService);
            container.register(DependencyContainer_1.ServiceType.UI_MANAGER, () => mockManager, [
                DependencyContainer_1.ServiceType.SETTINGS_COORDINATOR,
            ]);
            await container.resolve(DependencyContainer_1.ServiceType.UI_MANAGER);
    ...
    (0, vitest_1.describe)('Error handling', () => {
        ...
        (0, vitest_1.it)('should propagate errors from factory', async () => {
            ...
            await (0, vitest_1.expect)(container.resolve(DependencyContainer_1.ServiceType.UI_MANAGER)).rejects.toThrow('Factory error');
        });
        (0, vitest_1.it)('should propagate errors from async factory', async () => {
            ...
            await (0, vitest_1.expect)(container.resolve(DependencyContainer_1.ServiceType.UI_MANAGER)).rejects.toThrow('Async factory error');
        });
    });
});
