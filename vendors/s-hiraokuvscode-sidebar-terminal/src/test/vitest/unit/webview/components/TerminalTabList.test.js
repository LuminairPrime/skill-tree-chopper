...
(0, vitest_1.describe)('TerminalTabList', () => {
    ...
    (0, vitest_1.describe)('Drag and Drop', () => {
        (0, vitest_1.it)('should compute reorder based on current DOM order after previous reorders', () => {
            tabList.addTab({ id: 't1', name: 'T1', isActive: false, isClosable: true });
            tabList.addTab({ id: 't2', name: 'T2', isActive: false, isClosable: true });
            ...
            const dataTransfer = { effectAllowed: '', setData: vitest_1.vi.fn(), getData: vitest_1.vi.fn() };
            ...
            (0, vitest_1.expect)(mockEvents.onTabReorder).toHaveBeenCalledWith(0, 1, ['t3', 't2', 't1']);
        });
    });
