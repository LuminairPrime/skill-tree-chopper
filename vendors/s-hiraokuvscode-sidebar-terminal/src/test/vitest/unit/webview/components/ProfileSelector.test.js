...
(0, vitest_1.describe)('ProfileSelector Component', () => {
    ...
    (0, vitest_1.describe)('Initialization', () => {
        ...
        (0, vitest_1.it)('should be hidden by default', () => {
            ...
            (0, vitest_1.expect)(container.style.display === 'none' || container.style.display === '').toBe(true);
        });
    });
    ...
    (0, vitest_1.describe)('Profile List Display', () => {
        ...
        (0, vitest_1.it)('should mark default profile with badge', () => {
            profileSelector.show(mockProfiles);
            const bashProfile = Array.from(container.querySelectorAll('.profile-item')).find((item) => item.textContent?.includes('Bash'));
        ...
        (0, vitest_1.it)('should display profile descriptions', () => {
            profileSelector.show(mockProfiles);
            const descriptions = Array.from(container.querySelectorAll('.profile-item-description')).map((el) => el.textContent?.trim());
    ...
    (0, vitest_1.describe)('Profile Selection', () => {
        (0, vitest_1.it)('should select profile on click', () => {
            profileSelector.show(mockProfiles);
            const zshProfile = Array.from(container.querySelectorAll('.profile-item')).find((item) => item.textContent?.includes('Zsh'));
            zshProfile.click();
    ...
    (0, vitest_1.describe)('Keyboard Navigation', () => {
        ...
        (0, vitest_1.it)('should wrap around when navigating past first item', () => {
            ...
            container.dispatchEvent(arrowUpEvent);
            const powershellProfile = Array.from(container.querySelectorAll('.profile-item')).find((item) => item.textContent?.includes('PowerShell'));
