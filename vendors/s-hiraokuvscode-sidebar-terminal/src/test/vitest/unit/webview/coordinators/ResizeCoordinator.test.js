...
(0, vitest_1.describe)('ResizeCoordinator', () => {
    ...
    (0, vitest_1.describe)('initialize', () => {
        (0, vitest_1.it)('should set up resize listeners', () => {
            ...
            (0, vitest_1.expect)(addEventListenerSpy).toHaveBeenCalledWith('resize', vitest_1.expect.any(Function));
        });
    ...
    (0, vitest_1.describe)('refitAllTerminals', () => {
        ...
        (0, vitest_1.it)('should notify PTY with dimensions AFTER double-fit completes (Issue #368)', () => {
        ...
        (0, vitest_1.it)('should refresh terminal after double-fit to avoid stale render on shrink', () => {
            const fitCallOrder = [];
            let terminalDimensions = { cols: 80, rows: 24 };
            const mockFit = vitest_1.vi.fn().mockImplementation(() => {
                fitCallOrder.push('fit');
        ...
        (0, vitest_1.it)('should use deferred PTY notification for split mode timing (Issue #368)', () => {
    ...
    (0, vitest_1.describe)('setupPanelLocationListener', () => {
        (0, vitest_1.it)('should listen for panel location change events', () => {
            ...
            (0, vitest_1.expect)(addEventListenerSpy).toHaveBeenCalledWith('terminal-panel-location-changed', vitest_1.expect.any(Function));
        });
    ...
    (0, vitest_1.describe)('dispose', () => {
        ...
        (0, vitest_1.it)('Bug #7: should remove window resize listener on dispose', () => {
            ...
            const resizeRemoveCalls = removeEventListenerSpy.mock.calls.filter((call) => call[0] === 'resize');
