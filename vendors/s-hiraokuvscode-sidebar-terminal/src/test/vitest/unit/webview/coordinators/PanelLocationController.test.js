...
(0, vitest_1.describe)('PanelLocationController', () => {
  ...
  (0, vitest_1.describe)('setupPanelLocationSync (event handling)', () => {
    ...
    (0, vitest_1.it)(
      'should show all terminals split when panel with multiple terminals and not fullscreen',
      () => {
    ...
    (0, vitest_1.it)('should update split direction when no special conditions met', () => {
      ...
      (0, vitest_1.expect)(deps.splitManagerUpdateSplitDirection).toHaveBeenCalledWith(
        'horizontal',
        'panel'
      );
    });
