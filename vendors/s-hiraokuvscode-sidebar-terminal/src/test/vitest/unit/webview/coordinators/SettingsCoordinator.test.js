...
(0, vitest_1.describe)('SettingsCoordinator', () => {
    ...
    (0, vitest_1.describe)('applySettings', () => {
        (0, vitest_1.it)('should merge settings with current settings and update state', () => {
            ...
            (0, vitest_1.expect)(deps.setCurrentSettings).toHaveBeenCalledWith(vitest_1.expect.objectContaining({
                theme: 'dark',
                fontSize: 16,
        ...
        (0, vitest_1.it)('should update ConfigManager when available', () => {
            ...
            (0, vitest_1.expect)(deps.configManagerApplySettings).toHaveBeenCalledWith(vitest_1.expect.objectContaining({ theme: 'light' }), instances);
        });
        ...
        (0, vitest_1.it)('should set terminal header enhancements disabled when explicitly false', () => {
    ...
    (0, vitest_1.describe)('saveSettings', () => {
        (0, vitest_1.it)('should save current settings and font settings to state', () => {
            ...
            (0, vitest_1.expect)(deps.saveState).toHaveBeenCalledWith(vitest_1.expect.objectContaining({
    ...
    (0, vitest_1.describe)('applyFontSettings', () => {
        (0, vitest_1.it)('should delegate to fontSettingsUpdateSettings with split terminals', () => {
            ...
            (0, vitest_1.expect)(deps.fontSettingsUpdateSettings).toHaveBeenCalledWith(fontSettings, terminals);
        });
        (0, vitest_1.it)('should not throw on error', () => {
            vitest_1.vi.mocked(deps.fontSettingsUpdateSettings).mockImplementation(() => {
                throw new Error('Font error');
            });
            (0, vitest_1.expect)(() => coordinator.applyFontSettings({ fontFamily: 'monospace' })).not.toThrow();
        });
    });
    ...
    (0, vitest_1.describe)('openSettings', () => {
        (0, vitest_1.it)('should show settings panel with merged settings', () => {
            ...
            (0, vitest_1.expect)(deps.settingsPanelShow).toHaveBeenCalledWith(vitest_1.expect.objectContaining({
                theme: 'dark',
                fontSize: 14,
                lineHeight: 1.2,
            }));
        ...
        (0, vitest_1.it)('should use current settings as base when ConfigManager is not available', () => {
            vitest_1.vi.mocked(deps.hasConfigManager).mockReturnValue(false);
            vitest_1.vi.mocked(deps.getCurrentSettings).mockReturnValue({ theme: 'dark' });
            coordinator.openSettings();
            (0, vitest_1.expect)(deps.settingsPanelShow).toHaveBeenCalledWith(vitest_1.expect.objectContaining({ theme: 'dark' }));
        });
        (0, vitest_1.it)('should not throw on error', () => {
    ...
    (0, vitest_1.describe)('updateAllTerminalThemes', () => {
        ...
        (0, vitest_1.it)('should skip terminals without terminal instance', () => {
            ...
            vitest_1.vi.mocked(deps.getSplitTerminals).mockReturnValue(terminals);
            (0, vitest_1.expect)(() => coordinator.updateAllTerminalThemes({ background: '#000' })).not.toThrow();
        });
        (0, vitest_1.it)('should not throw on error', () => {
