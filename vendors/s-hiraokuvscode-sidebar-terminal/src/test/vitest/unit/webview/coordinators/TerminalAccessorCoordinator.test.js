...
function createDeps() {
    ...
    return {
        ...
        getAllTerminalInstances: vitest_1.vi.fn().mockReturnValue(new Map([['terminal-1', terminalInstance]])),
...
(0, vitest_1.describe)('TerminalAccessorCoordinator', () => {
    ...
    (0, vitest_1.it)('delegates terminal instance and container lookups', () => {
        ...
        (0, vitest_1.expect)(coordinator.getSerializeAddon('terminal-1')).toEqual({ id: 'serialize-addon' });
        ...
        (0, vitest_1.expect)(coordinator.getTerminalElement('terminal-1')).toEqual({ id: 'terminal-container' });
    });
    (0, vitest_1.it)('returns grouped managers and direct manager accessors', () => {
        ...
        (0, vitest_1.expect)(coordinator.getTerminalContainerManager()).toBe(deps.managers.terminalContainer);
