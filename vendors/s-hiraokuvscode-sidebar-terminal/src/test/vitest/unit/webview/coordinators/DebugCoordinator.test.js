...
(0, vitest_1.describe)('DebugCoordinator', () => {
    ...
    (0, vitest_1.describe)('updateDebugDisplay', () => {
        (0, vitest_1.it)('should delegate to debugPanelManager.updateDisplay', () => {
            ...
            (0, vitest_1.expect)(deps.debugPanelManager.updateDisplay).toHaveBeenCalledWith(state, 'test-operation');
        });
        (0, vitest_1.it)('should pass operation name for logging', () => {
            ...
            (0, vitest_1.expect)(deps.debugPanelManager.updateDisplay).toHaveBeenCalledWith(state, 'state-update');
        });
    });
    (0, vitest_1.describe)('toggleDebugPanel', () => {
        ...
        (0, vitest_1.it)('should request latest state if panel becomes active and no state provided', () => {
    ...
    (0, vitest_1.describe)('exportSystemDiagnostics', () => {
        (0, vitest_1.it)('should export diagnostics with system status', () => {
            ...
            (0, vitest_1.expect)(deps.debugPanelManager.exportDiagnostics).toHaveBeenCalledWith(deps.getSystemStatus(), 5);
        });
    });
