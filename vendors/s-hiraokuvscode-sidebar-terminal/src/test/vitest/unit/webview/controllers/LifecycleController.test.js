...
(0, vitest_1.describe)('LifecycleController', () => {
    ...
    (0, vitest_1.describe)('Bug #4: Addon cache serves disposed addons', () => {
        (0, vitest_1.it)('should not serve cached addon from a disposed terminal to a new terminal', () => {
            class MockAddon {
                constructor() {
                    this.dispose = vitest_1.vi.fn();
                }
        ...
        (0, vitest_1.it)('should clear cache entries belonging to disposed terminal on disposeTerminal', () => {
            class MockAddon {
                constructor() {
                    this.dispose = vitest_1.vi.fn();
                }
