...
(0, vitest_1.describe)('HeaderFactory', () => {
    ...
    (0, vitest_1.describe)('Status Management', () => {
        ...
        (0, vitest_1.it)('should update status when called multiple times', () => {
            ...
            (0, vitest_1.expect)(elements.statusSection.querySelectorAll('.ai-agent-status').length).toBe(1);
        });
    ...
    (0, vitest_1.describe)('UI Updates', () => {
        ...
        (0, vitest_1.it)('should update active state styles', () => {
            ...
            (0, vitest_1.expect)(elements.container.style.backgroundColor).toContain('inactiveBackground');
        });
    ...
    (0, vitest_1.describe)('Terminal Name Editing', () => {
        (0, vitest_1.it)('should not trigger header activation on second click of terminal-name double click', () => {
        ...
        (0, vitest_1.it)('should NOT close editor when clicking a color palette button', async () => {
            ...
            (0, vitest_1.expect)(elements.titleSection.querySelector('.terminal-header-editor')).toBeTruthy();
            ...
            (0, vitest_1.expect)(onHeaderUpdate).not.toHaveBeenCalledWith('t1', { indicatorColor: '#FF69B4' });
        });
        (0, vitest_1.it)('should NOT close editor when focus moves from input to a palette button (blur path)', async () => {
            const onHeaderUpdate = vitest_1.vi.fn();
            const elements = HeaderFactory_1.HeaderFactory.createTerminalHeader({
                terminalId: 't1',
                terminalName: 'Original',
        ...
        (0, vitest_1.it)('should NOT close editor when clicking the color palette area (non-button)', async () => {
            const onHeaderUpdate = vitest_1.vi.fn();
            const elements = HeaderFactory_1.HeaderFactory.createTerminalHeader({
                terminalId: 't1',
                terminalName: 'Original',
        ...
        (0, vitest_1.it)('should close editor when double-clicking the color palette area (non-button)', () => {
            const onHeaderUpdate = vitest_1.vi.fn();
            const elements = HeaderFactory_1.HeaderFactory.createTerminalHeader({
                terminalId: 't1',
                terminalName: 'Original',
            ...
            (0, vitest_1.expect)(elements.titleSection.querySelector('.terminal-header-editor')).toBeNull();
            (0, vitest_1.expect)(elements.nameSpan.textContent).toBe('Original');
        });
        (0, vitest_1.it)('should commit indicator color when closing the editor (palette dblclick)', () => {
            const onHeaderUpdate = vitest_1.vi.fn();
            const elements = HeaderFactory_1.HeaderFactory.createTerminalHeader({
                terminalId: 't1',
                terminalName: 'Original',
            ...
            const palette = elements.titleSection.querySelector('.terminal-header-color-palette');
            palette.dispatchEvent(new MouseEvent('dblclick', { bubbles: true }));
            (0, vitest_1.expect)(onHeaderUpdate).toHaveBeenCalledWith('t1', { indicatorColor: '#FF69B4' });
        });
        ...
        (0, vitest_1.it)('should open unified editor on header double click with color palette', () => {
            ...
            (0, vitest_1.expect)(editor).toBeTruthy();
            (0, vitest_1.expect)(input).toBeTruthy();
            (0, vitest_1.expect)(colorOptions).toHaveLength(HeaderFactory_1.HEADER_INDICATOR_COLOR_PALETTE.length);
        ...
        (0, vitest_1.it)('should update indicator color immediately from unified editor', () => {
            ...
            pinkOption.click();
            (0, vitest_1.expect)(onHeaderUpdate).not.toHaveBeenCalledWith('t1', { indicatorColor: '#FF69B4' });
            (0, vitest_1.expect)(elements.container.style.getPropertyValue('--terminal-indicator-color')).toBe('#FF69B4');
        });
        (0, vitest_1.it)('should provide OFF option and emit transparent indicator color', () => {
            ...
            offOption?.click();
            (0, vitest_1.expect)(onHeaderUpdate).not.toHaveBeenCalledWith('t1', { indicatorColor: 'transparent' });
            (0, vitest_1.expect)(elements.container.style.getPropertyValue('--terminal-indicator-color')).toBe('transparent');
        });
    });
    (0, vitest_1.describe)('Processing Indicator', () => {
        ...
        (0, vitest_1.it)('should keep processing indicator hidden when header enhancements are disabled', () => {
            const elements = HeaderFactory_1.HeaderFactory.createTerminalHeader({
                terminalId: 't1',
    ...
    (0, vitest_1.describe)('Header Enhancements Toggle', () => {
        (0, vitest_1.it)('should open rename editor without color palette when header enhancements are disabled', () => {
            const onHeaderUpdate = vitest_1.vi.fn();
            const elements = HeaderFactory_1.HeaderFactory.createTerminalHeader({
                terminalId: 't1',
                terminalName: 'Original',
            ...
            (0, vitest_1.expect)(onHeaderUpdate).not.toHaveBeenCalledWith('t1', vitest_1.expect.objectContaining({ indicatorColor: vitest_1.expect.any(String) }));
        });
    });
});
