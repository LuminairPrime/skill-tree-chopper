...
(0, vitest_1.describe)('TerminalContainerFactory', () => {
  ...
  (0, vitest_1.describe)('createContainer', () => {
    ...
    (0, vitest_1.it)('should create container with header when requested', () => {
      ...
      const elements = TerminalContainerFactory_1.TerminalContainerFactory.createContainer(
        config,
        headerConfig
      );
    ...
    (0, vitest_1.it)('should set correct data attributes', () => {
      ...
      const elements = TerminalContainerFactory_1.TerminalContainerFactory.createContainer(config);
      (0, vitest_1.expect)(elements.container.getAttribute('data-terminal-id')).toBe(
        'data-test-terminal'
      );
      (0, vitest_1.expect)(elements.container.getAttribute('data-terminal-name')).toBe(
        'Data Test Terminal'
      );
    });
  ...
  (0, vitest_1.describe)('header creation', () => {
    ...
    (0, vitest_1.it)('should create requested buttons (split is optional)', () => {
      ...
      const elements1 = TerminalContainerFactory_1.TerminalContainerFactory.createContainer(
        config,
        headerConfig1
      );
      ...
      const elements2 = TerminalContainerFactory_1.TerminalContainerFactory.createContainer(
        config,
        headerConfig2
      );
    ...
    (0, vitest_1.it)(
      'should not trigger container activation on second click of terminal-name double click',
      () => {
  ...
  (0, vitest_1.describe)('createSimpleContainer', () => {
    (0, vitest_1.it)('should create lightweight container', () => {
      const container = TerminalContainerFactory_1.TerminalContainerFactory.createSimpleContainer(
        'simple-1',
        'Simple Container'
      );
  ...
  (0, vitest_1.describe)('DOM integration', () => {
    (0, vitest_1.it)(
      'should NOT append container to main container by default (intentionally changed)',
      () => {
        const config = {
          id: 'dom-test',
          name: 'DOM Test',
