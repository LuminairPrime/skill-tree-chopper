...
(0, vitest_1.describe)('ToastNotificationService', () => {
    ...
    (0, vitest_1.describe)('showCompletedNotification', () => {
        (0, vitest_1.it)('should show completion notification', () => {
            ...
            (0, vitest_1.expect)(mockSetStatusBarMessage).toHaveBeenCalledWith(vitest_1.expect.stringContaining('completed'), vitest_1.expect.any(Number));
        });
        (0, vitest_1.it)('should include agent type in completion message', () => {
            service.showCompletedNotification('terminal-1', 'claude');
            (0, vitest_1.expect)(mockSetStatusBarMessage).toHaveBeenCalledWith(vitest_1.expect.stringContaining('Claude'), vitest_1.expect.any(Number));
        });
