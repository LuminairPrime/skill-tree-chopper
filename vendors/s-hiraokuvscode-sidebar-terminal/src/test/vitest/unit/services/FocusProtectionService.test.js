            ...
            onDidChangeActiveTerminal: vitest_1.vi.fn((listener) => {
                ...
                return {
                    dispose: vitest_1.vi.fn(() => {
                        ...
                        if (idx >= 0)
                            onDidChangeActiveTerminalListeners.splice(idx, 1);
                    }),
                };
            }),
            onDidOpenTerminal: vitest_1.vi.fn((listener) => {
                ...
                return {
                    dispose: vitest_1.vi.fn(() => {
                        ...
                        if (idx >= 0)
                            onDidOpenTerminalListeners.splice(idx, 1);
                    }),
                };
            }),
            ...
            onDidChangeConfiguration: vitest_1.vi.fn((listener) => {
                ...
                return {
                    dispose: vitest_1.vi.fn(() => {
                        ...
                        if (idx >= 0)
                            onDidChangeConfigurationListeners.splice(idx, 1);
                    }),
                };
            }),
...
(0, vitest_1.describe)('FocusProtectionService', () => {
    ...
    (0, vitest_1.describe)('initialization', () => {
        ...
        (0, vitest_1.it)('should read initial focusProtection setting', () => {
            (0, vitest_1.expect)(vscode.workspace.getConfiguration).toHaveBeenCalledWith('secondaryTerminal');
        });
    });
    (0, vitest_1.describe)('focus restoration with recent focus tracking', () => {
        (0, vitest_1.it)('should restore focus when terminal is currently focused', () => {
            ...
            (0, vitest_1.expect)(vscode.commands.executeCommand).toHaveBeenCalledWith('secondaryTerminal.focus');
        });
        (0, vitest_1.it)('should restore focus when terminal was recently focused (blur arrived first)', () => {
        ...
        (0, vitest_1.it)('should restore focus when recent focus was within 500ms (within 600ms window)', () => {
            mockIsTerminalFocused.mockReturnValue(false);
            mockIsWebViewVisible.mockReturnValue(true);
            service.notifyFocusChanged(true);
    ...
    (0, vitest_1.describe)('notifyInteraction (typing keeps focus window fresh)', () => {
        ...
        (0, vitest_1.it)('should NOT refresh window when terminal is not visible (avoid false positives)', () => {
            mockIsTerminalFocused.mockReturnValue(false);
            mockIsWebViewVisible.mockReturnValue(false);
        ...
        (0, vitest_1.it)('should restore focus when blur happens immediately after recent interaction without active terminal change', () => {
            mockIsTerminalFocused.mockReturnValue(true);
            mockIsWebViewVisible.mockReturnValue(true);
            service.notifyFocusChanged(true);
            service.notifyInteraction();
        ...
        (0, vitest_1.it)('should NOT restore focus on blur without recent interaction when active terminal does not change', () => {
            mockIsTerminalFocused.mockReturnValue(true);
            mockIsWebViewVisible.mockReturnValue(true);
            service.notifyFocusChanged(true);
    ...
    (0, vitest_1.describe)('terminal ID tracking (restore focus to the correct terminal)', () => {
        ...
        (0, vitest_1.it)('should track the most recent terminal ID across multiple interactions', () => {
            mockIsTerminalFocused.mockReturnValue(true);
            mockIsWebViewVisible.mockReturnValue(true);
    ...
    (0, vitest_1.describe)('diagnostic logging (onDidOpenTerminal / describeTerminal)', () => {
        ...
        (0, vitest_1.it)('should handle active-terminal change with rich creationOptions gracefully', () => {
            mockIsTerminalFocused.mockReturnValue(true);
            mockIsWebViewVisible.mockReturnValue(true);
            const richTerminal = {
                name: 'GitLens',
    ...
    (0, vitest_1.describe)('CLI agent connected mode (aggressive focus protection)', () => {
        (0, vitest_1.it)('should restore focus without recent interaction when CLI agent is connected', () => {
            mockIsTerminalFocused.mockReturnValue(false);
            mockIsWebViewVisible.mockReturnValue(true);
