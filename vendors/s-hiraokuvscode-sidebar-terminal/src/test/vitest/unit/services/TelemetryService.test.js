...
(0, vitest_1.describe)('TelemetryService', () => {
  ...
  (0, vitest_1.it)('should track extension activation', () => {
    ...
    (0, vitest_1.expect)(mockLogger.logUsage).toHaveBeenCalledWith(
      TelemetryService_1.TelemetryEventType.ExtensionActivated,
  ...
  (0, vitest_1.it)('should track extension deactivation with duration', () => {
    ...
    (0, vitest_1.expect)(mockLogger.logUsage).toHaveBeenCalledWith(
      TelemetryService_1.TelemetryEventType.ExtensionDeactivated,
      vitest_1.expect.objectContaining({
        extensionId: 'test-extension',
  ...
  (0, vitest_1.it)('should track terminal created without sensitive info', () => {
    ...
    (0, vitest_1.expect)(mockLogger.logUsage).toHaveBeenCalledWith(
      TelemetryService_1.TelemetryEventType.TerminalCreated,
      {
        hasProfile: true,
      }
    );
    // Ensure no sensitive data
    (0, vitest_1.expect)(mockLogger.logUsage).not.toHaveBeenCalledWith(
      vitest_1.expect.anything(),
      vitest_1.expect.objectContaining({ terminalId: 'term-123' })
    );
  });
  (0, vitest_1.it)('should track cli agent detection', () => {
    service.trackCliAgentDetected('claude');
    (0, vitest_1.expect)(mockLogger.logUsage).toHaveBeenCalledWith(
      TelemetryService_1.TelemetryEventType.CliAgentDetected,
      {
        agentType: 'claude',
      }
    );
  ...
  (0, vitest_1.it)('should track errors', () => {
    ...
    (0, vitest_1.expect)(mockLogger.logError).toHaveBeenCalledWith(
      TelemetryService_1.TelemetryEventType.ErrorOccurred,
      vitest_1.expect.objectContaining({
  ...
  (0, vitest_1.it)('should measure sync operation performance', () => {
    ...
    (0, vitest_1.expect)(mockLogger.logUsage).toHaveBeenCalledWith(
      TelemetryService_1.TelemetryEventType.PerformanceMetric,
      vitest_1.expect.objectContaining({
        operation: 'test-op',
        success: true,
