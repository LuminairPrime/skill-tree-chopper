...
(0, vitest_1.describe)('🧪 CLI Agent Detection Service - Comprehensive Test Suite', () => {
  ...
  vitest_1.describe.skip('🎯 Real Claude Code Output Pattern Tests', () => {
    ...
    realClaudeOutputs.forEach((output, index) => {
      (0, vitest_1.it)(
        `should detect Claude startup from real output #${index + 1}: "${output}"`,
        () => {
          // ACT
    ...
    realClaudeNonStartupOutputs.forEach((output, index) => {
      (0, vitest_1.it)(
        `should NOT detect Claude startup from non-startup output #${index + 1}: "${output}"`,
        () => {
          // ACT
          const result = detectionService.detectFromOutput('term1', output);
          // ASSERT
  ...
  vitest_1.describe.skip('🎯 Real Gemini CLI Output Pattern Tests', () => {
    ...
    realGeminiOutputs.forEach((output, index) => {
      (0, vitest_1.it)(
        `should detect Gemini startup from real output #${index + 1}: "${output}"`,
        () => {
          // ACT
          const result = detectionService.detectFromOutput('term1', output);
          // ASSERT
    ...
    realGeminiNonStartupOutputs.forEach((output, index) => {
      (0, vitest_1.it)(
        `should NOT detect Gemini startup from non-startup output #${index + 1}: "${output}"`,
        () => {
          // ACT
          const result = detectionService.detectFromOutput('term1', output);
          // ASSERT
  ...
  (0, vitest_1.describe)('🔄 Status Transition Tests (Critical for Bug Prevention)', () => {
    (0, vitest_1.it)(
      'should handle complete Claude lifecycle: none → connected → disconnected → none',
      () => {
        ...
        if (statusChangeEvents.length > 0) {
          (0, vitest_1.expect)(statusChangeEvents[statusChangeEvents.length - 1]?.status).toBe(
            'none'
          );
        }
      }
    ...
    (0, vitest_1.it)(
      '🚨 REGRESSION TEST: should NOT cause connected/disconnected flickering',
      () => {
  ...
  (0, vitest_1.describe)('🤝 Multiple Agent Management Tests', () => {
    ...
    (0, vitest_1.it)(
      'should reconnect disconnected terminal with its own detected agent type',
      () => {
    ...
    (0, vitest_1.it)(
      'should prevent promotion of disconnected agents via output re-processing',
      () => {
  ...
  (0, vitest_1.describe)('🔚 Termination Detection Tests', () => {
    ...
    realShellPrompts.forEach((prompt, index) => {
      ...
      (0, vitest_1.it)(
        `should detect termination from shell prompt #${index + 1}: "${prompt}"`,
        () => {
          // ACT
    ...
    realExitCommands.forEach((command, index) => {
      (0, vitest_1.it)(
        `should NOT detect termination from bare exit command #${index + 1}: "${command}"`,
        () => {
          // ACT
    ...
    (0, vitest_1.it)(
      'should detect termination from real agent output: [Process completed]',
      () => {
    ...
    (0, vitest_1.it)(
      'should detect termination from real agent output: Agent powering down. Goodbye!',
      () => {
  ...
  (0, vitest_1.describe)('⚠️ Error Handling and Edge Cases', () => {
    (0, vitest_1.it)('should handle empty and null data gracefully', () => {
      ...
      (0, vitest_1.expect)(() => detectionService.detectFromOutput('term1', '   ')).not.toThrow();
      (0, vitest_1.expect)(() =>
        detectionService.detectFromOutput('term1', '\n\r\n')
      ).not.toThrow();
  ...
  (0, vitest_1.describe)('⌨️ Input Detection Tests', () => {
    ...
    startupCommands.forEach((command, index) => {
      (0, vitest_1.it)(
        `should detect agent startup from input command #${index + 1}: "${command}"`,
        () => {
    ...
    (0, vitest_1.it)('should detect wrapped and prefixed launcher commands', () => {
      (0, vitest_1.expect)(detectionService.detectFromInput('term1', 'FOO=1 codex\r')?.type).toBe(
        'codex'
      );
      (0, vitest_1.expect)(
        detectionService.detectFromInput('term1', 'npx @openai/codex@latest\r')?.type
      ).toBe('codex');
      (0, vitest_1.expect)(
      ...
      (0, vitest_1.expect)(detectionService.detectFromInput('term1', 'bunx opencode\r')?.type).toBe(
        'opencode'
      );
      (0, vitest_1.expect)(
        detectionService.detectFromInput('term1', 'gh copilot suggest\r')?.type
      ).toBe('copilot');
    });
  });
  ...
  (0, vitest_1.describe)('🔗 Integration Tests', () => {
    ...
    (0, vitest_1.it)(
      '🚨 BUG REPRODUCTION: Agent status becomes "none" when it should stay "connected"',
      () => {
    ...
    (0, vitest_1.it)(
      'should terminate connected agent when Ctrl+C is followed by shell prompt',
      () => {
        detectionService.detectFromOutput('term1', 'Welcome to Claude Code!');
    ...
    (0, vitest_1.it)(
      'should terminate connected agent when Ctrl+C is pressed twice quickly',
      () => {
        detectionService.detectFromOutput('term1', 'Welcome to Claude Code!');
        detectionService.detectFromInput('term1', '\x03');
        (0, vitest_1.expect)(detectionService.getAgentState('term1').status).toBe('connected');
    ...
    (0, vitest_1.it)(
      'should terminate connected agent when Ctrl+C is followed by decorated zsh prompt',
      () => {
        detectionService.detectFromOutput('term1', 'Welcome to Claude Code!');
        detectionService.detectFromOutput('term1', 'Claude is thinking...');
        detectionService.detectFromInput('term1', '\x03');
    ...
    (0, vitest_1.it)(
      'should terminate connected agent on shell integration SIGINT completion',
      () => {
        detectionService.detectFromOutput('term1', 'Welcome to Claude Code!');
  ...
  (0, vitest_1.describe)('🧭 Refactored detection pipeline tests', () => {
    ...
    (0, vitest_1.it)(
      'keeps agent state stable when the user submits input after waiting-like output',
      () => {
