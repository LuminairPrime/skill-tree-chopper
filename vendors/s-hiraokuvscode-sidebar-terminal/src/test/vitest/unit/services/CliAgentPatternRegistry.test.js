...
(0, vitest_1.describe)('CliAgentPatternRegistry', () => {
    ...
    (0, vitest_1.describe)('matchCommandInput', () => {
        ...
        (0, vitest_1.it)('should match wrapper commands and env-prefixed commands', () => {
            ...
            (0, vitest_1.expect)(registry.matchCommandInput('pnpm dlx @google/gemini-cli')).toBe('gemini');
            (0, vitest_1.expect)(registry.matchCommandInput('yarn dlx @anthropic-ai/claude-code')).toBe('claude');
    ...
    (0, vitest_1.describe)('matchStartupOutput', () => {
        ...
        (0, vitest_1.it)('should match GitHub Copilot CLI startup message', () => {
            (0, vitest_1.expect)(registry.matchStartupOutput('Welcome to GitHub Copilot CLI')).toBe('copilot');
        });
    ...
    (0, vitest_1.describe)('isAgentActivity', () => {
        ...
        (0, vitest_1.it)('should not treat generic long text as agent activity', () => {
            (0, vitest_1.expect)(registry.isAgentActivity('This output is very long but does not include any known agent keywords and should not count as agent activity')).toBe(false);
        });
    });
    (0, vitest_1.describe)('isShellPrompt', () => {
        ...
        (0, vitest_1.it)('should return false for long output lines', () => {
            (0, vitest_1.expect)(registry.isShellPrompt('This is a very long line that clearly is not a prompt even if it has $ in it')).toBe(false);
        });
    });
    (0, vitest_1.describe)('isTerminationPattern', () => {
        (0, vitest_1.describe)('should detect real agent termination output', () => {
            ...
            (0, vitest_1.it)('should detect process exit with code', () => {
                (0, vitest_1.expect)(registry.isTerminationPattern('[process exited with code 0]')).toBe(true);
                (0, vitest_1.expect)(registry.isTerminationPattern('[process exited with code 130]')).toBe(true);
            });
            (0, vitest_1.it)('should detect Gemini farewell message', () => {
                (0, vitest_1.expect)(registry.isTerminationPattern('Agent powering down. Goodbye!')).toBe(true);
            });
            (0, vitest_1.it)('should detect command not found errors', () => {
                ...
                (0, vitest_1.expect)(registry.isTerminationPattern('command not found: copilot')).toBe(true);
                (0, vitest_1.expect)(registry.isTerminationPattern('command not found: opencode')).toBe(true);
            });
        });
        (0, vitest_1.describe)('should NOT false-positive on generic words', () => {
            ...
            (0, vitest_1.it)('should not detect conversational goodbye messages', () => {
                (0, vitest_1.expect)(registry.isTerminationPattern('Goodbye! Have a great day!')).toBe(false);
            });
            (0, vitest_1.it)('should not detect exit in explanatory text', () => {
                (0, vitest_1.expect)(registry.isTerminationPattern('You can exit the program by...')).toBe(false);
            });
        ...
        (0, vitest_1.describe)('should still detect crash indicators', () => {
            ...
            (0, vitest_1.it)('should detect fatal error out of memory', () => {
                (0, vitest_1.expect)(registry.isTerminationPattern('FATAL ERROR: out of memory')).toBe(true);
            });
        ...
        (0, vitest_1.describe)('should not false-positive on broad crash indicators', () => {
            (0, vitest_1.it)('should not detect killed in normal output', () => {
                (0, vitest_1.expect)(registry.isTerminationPattern('The process killed the zombie')).toBe(false);
            });
            ...
            (0, vitest_1.it)('should not detect exception in normal output', () => {
                (0, vitest_1.expect)(registry.isTerminationPattern('Handle the exception gracefully')).toBe(false);
            });
        ...
        (0, vitest_1.describe)('should detect agent-specific termination patterns', () => {
            (0, vitest_1.it)('should detect Claude termination with agent type', () => {
                (0, vitest_1.expect)(registry.isTerminationPattern('[Process completed]', 'claude')).toBe(true);
            });
            (0, vitest_1.it)('should detect Gemini termination with agent type', () => {
                (0, vitest_1.expect)(registry.isTerminationPattern('Agent powering down. Goodbye!', 'gemini')).toBe(true);
            });
            (0, vitest_1.it)('should detect process exit code for codex', () => {
                (0, vitest_1.expect)(registry.isTerminationPattern('[process exited with code 0]', 'codex')).toBe(true);
            });
        });
    });
    (0, vitest_1.describe)('cleanAnsiEscapeSequences', () => {
        ...
        (0, vitest_1.it)('should remove carriage returns and control chars while preserving line boundaries', () => {
            const raw = 'line1\r\nline2\x07';
