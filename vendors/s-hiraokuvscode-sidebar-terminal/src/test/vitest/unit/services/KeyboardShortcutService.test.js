...
(0, vitest_1.describe)('KeyboardShortcutService', () => {
  ...
  (0, vitest_1.it)(
    'should create terminal with fullscreen display override when no default profile',
    async () => {
  ...
  (0, vitest_1.it)(
    'should create terminal with fullscreen display override when default profile exists',
    async () => {
  ...
  (0, vitest_1.it)('should exit panel navigation mode context via command', async () => {
    ...
    await toggleHandler?.();
    await exitHandler?.();
    (0, vitest_1.expect)(mocks.mockCommands.executeCommand).toHaveBeenLastCalledWith(
      'setContext',
      'secondaryTerminal.panelNavigationMode',
      false
    );
  ...
  (0, vitest_1.describe)('Panel Navigation Enabled', () => {
    (0, vitest_1.it)(
      'should initialize panel navigation enabled context key from settings (default: false)',
      () => {
        (0, vitest_1.expect)(mocks.mockCommands.executeCommand).toHaveBeenCalledWith(
          'setContext',
    ...
    (0, vitest_1.it)(
      'should initialize panel navigation enabled context key as true when setting is enabled',
      () => {
        mocks.mockCommands.executeCommand.mockClear();
        mocks.mockWorkspace.getConfiguration.mockReturnValue({
    ...
    (0, vitest_1.it)(
      'should update panel navigation enabled context key when configuration changes',
      () => {
        mocks.mockWorkspace.getConfiguration.mockReturnValue({
          get: vitest_1.vi.fn().mockReturnValue(true),
        });
    ...
    (0, vitest_1.it)('should not react to unrelated configuration changes', () => {
      ...
      (0, vitest_1.expect)(mocks.mockCommands.executeCommand).not.toHaveBeenCalledWith(
        'setContext',
        'secondaryTerminal.panelNavigation.enabled',
