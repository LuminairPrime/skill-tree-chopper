...
(0, vitest_1.describe)('CliAgentDetectionEngine', () => {
    ...
    (0, vitest_1.describe)('detectFromOutput', () => {
        ...
        (0, vitest_1.it)('should detect opencode startup from shell integration command execution', () => {
        ...
        (0, vitest_1.it)('should detect Claude Code even if whitespace between words is missing after ANSI cleaning', () => {
    ...
    (0, vitest_1.describe)('detectTermination', () => {
        ...
        (0, vitest_1.it)('should not treat Claude TUI prompt "❯" as shell termination (prevents connected -> none flip)', () => {
        ...
        (0, vitest_1.it)('should not terminate on "❯" even if currentAgentType is missing but shell integration context indicates claude', () => {
        ...
        (0, vitest_1.it)('should detect termination when Ctrl+C is followed by decorated zsh prompt', () => {
            engine.detectFromInput(terminalId, '\x03');
            engine.detectFromOutput(terminalId, 'Claude is thinking...');
        ...
        (0, vitest_1.it)('should detect termination from double Ctrl+C input without shell prompt', () => {
            engine.detectFromInput(terminalId, '\x03');
        ...
        (0, vitest_1.it)('should not treat generic long output as AI activity', () => {
            engine.detectFromOutput(terminalId, 'This is a very long plain output line without any agent related keywords to simulate normal command output');
            const result = engine.detectTermination(terminalId, 'user@host:~$ ');
            (0, vitest_1.expect)(result.isTerminated).toBe(true);
        });
        ...
        (0, vitest_1.it)('should treat embedded agent keywords as non-keywords in timeout prompt detection', () => {
