...
(0, vitest_1.describe)('NotificationCoordinator', () => {
    ...
    (0, vitest_1.describe)('notifyCompleted', () => {
        (0, vitest_1.it)('should call toast and native for completion notification', () => {
            ...
            (0, vitest_1.expect)(mockToast.showCompletedNotification).toHaveBeenCalledWith('terminal-1', 'claude');
            (0, vitest_1.expect)(mockNative.notifyCompleted).toHaveBeenCalledWith('terminal-1', 'Sidebar Terminal', vitest_1.expect.stringContaining('Claude has completed'));
        });
        (0, vitest_1.it)('should use "CLI Agent" when agentType is null', () => {
            coordinator.notifyCompleted('terminal-1', null);
            (0, vitest_1.expect)(mockNative.notifyCompleted).toHaveBeenCalledWith('terminal-1', 'Sidebar Terminal', vitest_1.expect.stringContaining('CLI Agent has completed'));
        });
