...
(0, vitest_1.describe)('TerminalLinksService', () => {
    ...
    (0, vitest_1.describe)('detectLinks', () => {
        ...
        (0, vitest_1.it)('should fire event when links detected', async () => {
            ...
            (0, vitest_1.expect)(mocks.mockEventEmitter.fire).toHaveBeenCalledWith(vitest_1.expect.objectContaining({
                terminalId: 't1',
                links: vitest_1.expect.arrayContaining([vitest_1.expect.objectContaining({ type: 'url' })]),
            }));
        });
    });
    (0, vitest_1.describe)('activateLink', () => {
        ...
        (0, vitest_1.it)('should activate folder link', async () => {
            ...
            await service.activateLink(link);
            (0, vitest_1.expect)(mocks.mockCommands.executeCommand).toHaveBeenCalledWith('revealFileInOS', vitest_1.expect.anything());
        });
