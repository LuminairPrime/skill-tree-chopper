...
(0, vitest_1.describe)('ShellIntegrationService', () => {
  ...
  (0, vitest_1.beforeEach)(() => {
    ...
    service = new ShellIntegrationService_1.ShellIntegrationService(
      mockTerminalManager,
      mockContext
    );
  });
  ...
  (0, vitest_1.describe)('OSC Sequence Processing', () => {
    ...
    (0, vitest_1.it)('should detect CWD change', () => {
      ...
      (0, vitest_1.expect)(mockTerminalManager.updateTerminalCwd).toHaveBeenCalledWith(
        termId,
        '/new/path'
      );
      (0, vitest_1.expect)(vscode.commands.executeCommand).toHaveBeenCalledWith(
  ...
  (0, vitest_1.describe)('Shell Injection', () => {
    (0, vitest_1.it)('should inject bash/zsh integration', async () => {
      ...
      (0, vitest_1.expect)(pty.write).toHaveBeenCalledWith(
        vitest_1.expect.stringContaining('__vsc_prompt_cmd')
      );
    });
    (0, vitest_1.it)('should inject fish integration', async () => {
      ...
      (0, vitest_1.expect)(pty.write).toHaveBeenCalledWith(
        vitest_1.expect.stringContaining('__vsc_prompt')
      );
    });
    (0, vitest_1.it)('should inject powershell integration', async () => {
      ...
      (0, vitest_1.expect)(pty.write).toHaveBeenCalledWith(
        vitest_1.expect.stringContaining('__VSCode-Prompt-Start')
      );
    });
