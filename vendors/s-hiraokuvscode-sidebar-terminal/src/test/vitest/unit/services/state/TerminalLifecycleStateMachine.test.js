...
(0, vitest_1.describe)('TerminalLifecycleStateMachine', () => {
    (0, vitest_1.describe)('Basic State Management', () => {
        (0, vitest_1.it)('should initialize with Creating state by default', () => {
            const stateMachine = new TerminalLifecycleStateMachine_1.TerminalLifecycleStateMachine('term1');
            (0, vitest_1.expect)(stateMachine.getCurrentState()).toBe(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Creating);
        });
        (0, vitest_1.it)('should initialize with custom initial state', () => {
            const stateMachine = new TerminalLifecycleStateMachine_1.TerminalLifecycleStateMachine('term1', TerminalLifecycleStateMachine_1.TerminalLifecycleState.Ready);
            (0, vitest_1.expect)(stateMachine.getCurrentState()).toBe(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Ready);
        });
        ...
        (0, vitest_1.it)('should correctly check if in specific state', () => {
            const stateMachine = new TerminalLifecycleStateMachine_1.TerminalLifecycleStateMachine('term1', TerminalLifecycleStateMachine_1.TerminalLifecycleState.Ready);
            (0, vitest_1.expect)(stateMachine.isInState(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Ready)).toBe(true);
            (0, vitest_1.expect)(stateMachine.isInState(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Active)).toBe(false);
        });
        (0, vitest_1.it)('should correctly check if in any of specified states', () => {
            const stateMachine = new TerminalLifecycleStateMachine_1.TerminalLifecycleStateMachine('term1', TerminalLifecycleStateMachine_1.TerminalLifecycleState.Ready);
            (0, vitest_1.expect)(stateMachine.isInAnyState([TerminalLifecycleStateMachine_1.TerminalLifecycleState.Ready, TerminalLifecycleStateMachine_1.TerminalLifecycleState.Active])).toBe(true);
            (0, vitest_1.expect)(stateMachine.isInAnyState([
    ...
    (0, vitest_1.describe)('State Transition Rules', () => {
        (0, vitest_1.it)('should allow valid transition: Creating -> Initializing', () => {
            const stateMachine = new TerminalLifecycleStateMachine_1.TerminalLifecycleStateMachine('term1');
            (0, vitest_1.expect)(() => stateMachine.transition(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Initializing)).not.toThrow();
            (0, vitest_1.expect)(stateMachine.getCurrentState()).toBe(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Initializing);
        });
        (0, vitest_1.it)('should allow valid transition: Initializing -> Ready', () => {
            const stateMachine = new TerminalLifecycleStateMachine_1.TerminalLifecycleStateMachine('term1', TerminalLifecycleStateMachine_1.TerminalLifecycleState.Initializing);
            (0, vitest_1.expect)(() => stateMachine.transition(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Ready)).not.toThrow();
            (0, vitest_1.expect)(stateMachine.getCurrentState()).toBe(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Ready);
        });
        (0, vitest_1.it)('should allow valid transition: Ready -> Active', () => {
            const stateMachine = new TerminalLifecycleStateMachine_1.TerminalLifecycleStateMachine('term1', TerminalLifecycleStateMachine_1.TerminalLifecycleState.Ready);
            (0, vitest_1.expect)(() => stateMachine.transition(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Active)).not.toThrow();
            (0, vitest_1.expect)(stateMachine.getCurrentState()).toBe(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Active);
        });
        (0, vitest_1.it)('should allow valid transition: Active -> Ready', () => {
            const stateMachine = new TerminalLifecycleStateMachine_1.TerminalLifecycleStateMachine('term1', TerminalLifecycleStateMachine_1.TerminalLifecycleState.Active);
            (0, vitest_1.expect)(() => stateMachine.transition(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Ready)).not.toThrow();
            (0, vitest_1.expect)(stateMachine.getCurrentState()).toBe(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Ready);
        });
        (0, vitest_1.it)('should allow valid transition: Active -> Closing', () => {
            const stateMachine = new TerminalLifecycleStateMachine_1.TerminalLifecycleStateMachine('term1', TerminalLifecycleStateMachine_1.TerminalLifecycleState.Active);
            (0, vitest_1.expect)(() => stateMachine.transition(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Closing)).not.toThrow();
            (0, vitest_1.expect)(stateMachine.getCurrentState()).toBe(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Closing);
        });
        (0, vitest_1.it)('should allow valid transition: Closing -> Closed', () => {
            const stateMachine = new TerminalLifecycleStateMachine_1.TerminalLifecycleStateMachine('term1', TerminalLifecycleStateMachine_1.TerminalLifecycleState.Closing);
            (0, vitest_1.expect)(() => stateMachine.transition(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Closed)).not.toThrow();
            (0, vitest_1.expect)(stateMachine.getCurrentState()).toBe(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Closed);
        });
        (0, vitest_1.it)('should allow transition to Error from any non-terminal state', () => {
            ...
            for (const state of states) {
                const stateMachine = new TerminalLifecycleStateMachine_1.TerminalLifecycleStateMachine('term1', state);
                (0, vitest_1.expect)(() => stateMachine.transition(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Error)).not.toThrow();
                (0, vitest_1.expect)(stateMachine.getCurrentState()).toBe(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Error);
            }
        });
        (0, vitest_1.it)('should reject invalid transition: Creating -> Ready', () => {
            const stateMachine = new TerminalLifecycleStateMachine_1.TerminalLifecycleStateMachine('term1');
            (0, vitest_1.expect)(() => stateMachine.transition(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Ready)).toThrow('Invalid state transition');
        });
        (0, vitest_1.it)('should reject invalid transition: Ready -> Initializing', () => {
            const stateMachine = new TerminalLifecycleStateMachine_1.TerminalLifecycleStateMachine('term1', TerminalLifecycleStateMachine_1.TerminalLifecycleState.Ready);
            (0, vitest_1.expect)(() => stateMachine.transition(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Initializing)).toThrow('Invalid state transition');
        });
        (0, vitest_1.it)('should reject any transition from Closed state', () => {
            const stateMachine = new TerminalLifecycleStateMachine_1.TerminalLifecycleStateMachine('term1', TerminalLifecycleStateMachine_1.TerminalLifecycleState.Closed);
            (0, vitest_1.expect)(() => stateMachine.transition(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Ready)).toThrow('Invalid state transition');
        });
        (0, vitest_1.it)('should correctly identify valid next states', () => {
            const stateMachine = new TerminalLifecycleStateMachine_1.TerminalLifecycleStateMachine('term1', TerminalLifecycleStateMachine_1.TerminalLifecycleState.Ready);
            const validStates = stateMachine.getValidNextStates();
            (0, vitest_1.expect)(validStates).toContain(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Active);
            (0, vitest_1.expect)(validStates).toContain(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Closing);
            (0, vitest_1.expect)(validStates).toContain(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Error);
            (0, vitest_1.expect)(validStates).not.toContain(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Initializing);
        });
        (0, vitest_1.it)('should correctly check if transition is valid', () => {
            const stateMachine = new TerminalLifecycleStateMachine_1.TerminalLifecycleStateMachine('term1', TerminalLifecycleStateMachine_1.TerminalLifecycleState.Ready);
            (0, vitest_1.expect)(stateMachine.canTransitionTo(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Active)).toBe(true);
            (0, vitest_1.expect)(stateMachine.canTransitionTo(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Initializing)).toBe(false);
        });
    });
    ...
    (0, vitest_1.describe)('Transition History', () => {
        (0, vitest_1.it)('should track transition history', () => {
            ...
            (0, vitest_1.expect)(history[0].from).toBe(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Creating);
            (0, vitest_1.expect)(history[0].to).toBe(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Initializing);
            (0, vitest_1.expect)(history[1].from).toBe(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Initializing);
            (0, vitest_1.expect)(history[1].to).toBe(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Ready);
            (0, vitest_1.expect)(history[2].from).toBe(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Ready);
            (0, vitest_1.expect)(history[2].to).toBe(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Active);
        });
        (0, vitest_1.it)('should limit history size', () => {
            const stateMachine = new TerminalLifecycleStateMachine_1.TerminalLifecycleStateMachine('term1', TerminalLifecycleStateMachine_1.TerminalLifecycleState.Creating, 2 // Max history size
            );
            stateMachine.transition(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Initializing);
            stateMachine.transition(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Ready);
            stateMachine.transition(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Active);
            ...
            (0, vitest_1.expect)(history[0].to).toBe(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Ready);
            (0, vitest_1.expect)(history[1].to).toBe(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Active);
        });
        ...
        (0, vitest_1.it)('should return last transition', () => {
            ...
            (0, vitest_1.expect)(lastTransition).toBeDefined();
            if (lastTransition) {
                (0, vitest_1.expect)(lastTransition.to).toBe(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Ready);
            }
        });
    ...
    (0, vitest_1.describe)('State Change Listeners', () => {
        (0, vitest_1.it)('should notify listeners on state change', () => {
            ...
            (0, vitest_1.expect)(eventReceived.previousState).toBe(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Creating);
            (0, vitest_1.expect)(eventReceived.newState).toBe(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Initializing);
        });
    ...
    (0, vitest_1.describe)('Force Transition', () => {
        (0, vitest_1.it)('should allow forced transition bypassing validation', () => {
            ...
            (0, vitest_1.expect)(() => stateMachine.transition(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Closed)).toThrow();
            // Should work with force
            (0, vitest_1.expect)(() => stateMachine.forceTransition(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Closed)).not.toThrow();
            (0, vitest_1.expect)(stateMachine.getCurrentState()).toBe(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Closed);
        });
        (0, vitest_1.it)('should record forced transitions in history', () => {
            ...
            (0, vitest_1.expect)(lastTransition).toBeDefined();
            if (lastTransition) {
                (0, vitest_1.expect)(lastTransition.to).toBe(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Closed);
    ...
    (0, vitest_1.describe)('State Summary', () => {
        (0, vitest_1.it)('should provide complete state summary', () => {
            ...
            (0, vitest_1.expect)(summary.currentState).toBe(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Ready);
            (0, vitest_1.expect)(summary.validNextStates).toContain(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Active);
...
(0, vitest_1.describe)('TerminalLifecycleStateMachineManager', () => {
    ...
    (0, vitest_1.describe)('State Machine Creation', () => {
        ...
        (0, vitest_1.it)('should create state machine with custom initial state', () => {
            const stateMachine = manager.createStateMachine('term1', TerminalLifecycleStateMachine_1.TerminalLifecycleState.Ready);
            (0, vitest_1.expect)(stateMachine.getCurrentState()).toBe(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Ready);
        });
    });
    ...
    (0, vitest_1.describe)('State Queries', () => {
        (0, vitest_1.it)('should get current state for terminal', () => {
            ...
            (0, vitest_1.expect)(state).toBe(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Initializing);
        });
        ...
        (0, vitest_1.it)('should check if terminal is in specific state', () => {
            const stateMachine = manager.createStateMachine('term1');
            stateMachine.transition(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Initializing);
            (0, vitest_1.expect)(manager.isTerminalInState('term1', TerminalLifecycleStateMachine_1.TerminalLifecycleState.Initializing)).toBe(true);
            (0, vitest_1.expect)(manager.isTerminalInState('term1', TerminalLifecycleStateMachine_1.TerminalLifecycleState.Ready)).toBe(false);
        });
        ...
        (0, vitest_1.it)('should get all terminals in specific state', () => {
            ...
            const readyTerminals = manager.getTerminalsInState(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Ready);
            ...
            const initializingTerminals = manager.getTerminalsInState(TerminalLifecycleStateMachine_1.TerminalLifecycleState.Initializing);
