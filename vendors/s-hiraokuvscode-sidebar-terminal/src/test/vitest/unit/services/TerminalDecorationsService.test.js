...
(0, vitest_1.describe)('TerminalDecorationsService', () => {
  ...
  (0, vitest_1.describe)('addDecoration', () => {
    (0, vitest_1.it)('should add decoration and fire event', () => {
      ...
      (0, vitest_1.expect)(mockEventEmitter.fire).toHaveBeenCalledWith(
        vitest_1.expect.objectContaining({
          terminalId: 't1',
          decorations: vitest_1.expect.arrayContaining([
            vitest_1.expect.objectContaining({ commandId: 'cmd1' }),
          ]),
        })
      );
    });
