...
(0, vitest_1.describe)('DIContainer', () => {
    ...
    (0, vitest_1.describe)('Service Registration', () => {
        ...
        (0, vitest_1.it)('should throw error when registering duplicate service', () => {
            const ILogger = (0, DIContainer_1.createServiceToken)('ILogger');
            container.register(ILogger, () => ({ log: () => { } }), DIContainer_1.ServiceLifetime.Singleton);
            (0, vitest_1.expect)(() => container.register(ILogger, () => ({ log: () => { } }), DIContainer_1.ServiceLifetime.Singleton)).toThrow('Service already registered: ILogger');
        });
    ...
    (0, vitest_1.describe)('Singleton Lifetime', () => {
        (0, vitest_1.it)('should return same instance for singleton services', () => {
            const ILogger = (0, DIContainer_1.createServiceToken)('ILogger');
            let idCounter = 0;
            container.register(ILogger, () => ({ id: ++idCounter }), DIContainer_1.ServiceLifetime.Singleton);
    ...
    (0, vitest_1.describe)('Transient Lifetime', () => {
        (0, vitest_1.it)('should return new instance for transient services', () => {
            const ILogger = (0, DIContainer_1.createServiceToken)('ILogger');
            let idCounter = 0;
            container.register(ILogger, () => ({ id: ++idCounter }), DIContainer_1.ServiceLifetime.Transient);
            const instance1 = container.resolve(ILogger);
            const instance2 = container.resolve(ILogger);
    ...
    (0, vitest_1.describe)('Scoped Lifetime', () => {
        (0, vitest_1.it)('should return same instance within a scope', () => {
            const ILogger = (0, DIContainer_1.createServiceToken)('ILogger');
            let idCounter = 0;
            container.register(ILogger, () => ({ id: ++idCounter }), DIContainer_1.ServiceLifetime.Scoped);
    ...
    (0, vitest_1.describe)('Circular Dependency Detection', () => {
        (0, vitest_1.it)('should detect circular dependencies', () => {
            ...
            container.register(IServiceA, (c) => ({ b: c.resolve(IServiceB) }), DIContainer_1.ServiceLifetime.Singleton);
            container.register(IServiceB, (c) => ({ a: c.resolve(IServiceA) }), DIContainer_1.ServiceLifetime.Singleton);
            (0, vitest_1.expect)(() => container.resolve(IServiceA)).toThrow(DIContainer_1.CircularDependencyError);
        });
    ...
    (0, vitest_1.describe)('Service Resolution', () => {
        (0, vitest_1.it)('should throw error when resolving unregistered service', () => {
            const ILogger = (0, DIContainer_1.createServiceToken)('ILogger');
            (0, vitest_1.expect)(() => container.resolve(ILogger)).toThrow(DIContainer_1.ServiceNotRegisteredError);
        });
        ...
        (0, vitest_1.it)('should resolve dependencies recursively', () => {
            ...
            container.register(ILogger, () => ({ log: () => { } }), DIContainer_1.ServiceLifetime.Singleton);
            container.register(IService, (c) => ({ logger: c.resolve(ILogger) }), DIContainer_1.ServiceLifetime.Singleton);
    ...
    (0, vitest_1.describe)('Disposal', () => {
        ...
        (0, vitest_1.it)('should throw error when using disposed container', () => {
            ...
            container.dispose();
            (0, vitest_1.expect)(() => container.resolve(IService)).toThrow('Cannot use disposed DIContainer');
        });
