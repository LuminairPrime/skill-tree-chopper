...
class TestInitializationTemplate
  extends WebViewInitializationTemplate_1.WebViewInitializationTemplate
{
  constructor() {
    super(...arguments);
...
(0, vitest_1.describe)('WebViewInitializationTemplate', () => {
  ...
  (0, vitest_1.it)('should throw error if errorRecovery is false', async () => {
    ...
    await (0, vitest_1.expect)(errorTemplate.initialize({ errorRecovery: false })).rejects.toThrow(
      'Content failure'
    );
  });
});
