...
(0, vitest_1.describe)('arraysEqual', () => {
  (0, vitest_1.describe)('with primitive values', () => {
    ...
    (0, vitest_1.it)('should return true for equal arrays of strings', () => {
      (0, vitest_1.expect)((0, arrayUtils_1.arraysEqual)(['a', 'b', 'c'], ['a', 'b', 'c'])).toBe(
        true
      );
    });
    ...
    (0, vitest_1.it)('should handle arrays with null and undefined', () => {
      (0, vitest_1.expect)(
        (0, arrayUtils_1.arraysEqual)([null, undefined], [null, undefined])
      ).toBe(true);
  ...
  (0, vitest_1.describe)('with objects', () => {
    (0, vitest_1.it)(
      'should return false for arrays with same object values but different references',
      () => {
...
(0, vitest_1.describe)('haveSameElements', () => {
  ...
  (0, vitest_1.it)('should handle strings', () => {
    (0, vitest_1.expect)((0, arrayUtils_1.haveSameElements)(['a', 'b', 'c'], ['c', 'b', 'a'])).toBe(
      true
    );
    (0, vitest_1.expect)((0, arrayUtils_1.haveSameElements)(['a', 'b'], ['a', 'c'])).toBe(false);
  });
  (0, vitest_1.it)('should handle mixed types', () => {
    (0, vitest_1.expect)((0, arrayUtils_1.haveSameElements)([1, 'a', true], ['a', true, 1])).toBe(
      true
    );
    (0, vitest_1.expect)((0, arrayUtils_1.haveSameElements)([1, 'a', true], [1, 'a', false])).toBe(
      false
    );
  });
});
(0, vitest_1.describe)('unique', () => {
  ...
  (0, vitest_1.it)('should remove duplicate strings', () => {
    (0, vitest_1.expect)((0, arrayUtils_1.unique)(['a', 'b', 'a', 'c', 'b'])).toEqual([
      'a',
      'b',
      'c',
    ]);
  ...
  (0, vitest_1.it)('should handle null and undefined', () => {
    (0, vitest_1.expect)((0, arrayUtils_1.unique)([null, undefined, null, undefined])).toEqual([
      null,
      undefined,
    ]);
  });
...
(0, vitest_1.describe)('chunk', () => {
  ...
  (0, vitest_1.it)('should handle array with length not divisible by chunk size', () => {
    (0, vitest_1.expect)((0, arrayUtils_1.chunk)([1, 2, 3, 4, 5], 2)).toEqual([
      [1, 2],
      [3, 4],
      [5],
    ]);
