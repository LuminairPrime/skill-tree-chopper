...
(0, vitest_1.describe)('Feedback Utilities', () => {
  ...
  (0, vitest_1.describe)('TerminalErrorHandler', () => {
    (0, vitest_1.it)('should handle ENOENT error', () => {
      feedback_1.TerminalErrorHandler.handleTerminalCreationError(
        new Error('ENOENT: file not found')
      );
      (0, vitest_1.expect)(vscode.window.showErrorMessage).toHaveBeenCalledWith(
        vitest_1.expect.stringContaining('Shell not found'),
    ...
    (0, vitest_1.it)('should handle permission denied errors', () => {
      ...
      (0, vitest_1.expect)(vscode.window.showErrorMessage).toHaveBeenCalledWith(
        vitest_1.expect.stringContaining('Permission denied'),
        'Learn More'
      );
    });
    (0, vitest_1.it)('should handle max terminals reached', () => {
      ...
      (0, vitest_1.expect)(vscode.window.showWarningMessage).toHaveBeenCalledWith(
        vitest_1.expect.stringContaining('Maximum number of terminals reached (5)'),
        vitest_1.expect.anything()
      );
    });
    (0, vitest_1.it)('should handle webview errors', () => {
      ...
      (0, vitest_1.expect)(vscode.window.showErrorMessage).toHaveBeenCalledWith(
        vitest_1.expect.stringContaining('Webview error'),
        vitest_1.expect.anything()
      );
    });
  });
