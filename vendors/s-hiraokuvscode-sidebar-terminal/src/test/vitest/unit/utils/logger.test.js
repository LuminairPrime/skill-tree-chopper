...
(0, vitest_1.describe)('Logger', () => {
    ...
    (0, vitest_1.describe)('Categorized Logging', () => {
        ...
        (0, vitest_1.it)('should format terminal logs with emoji', () => {
            ...
            (0, vitest_1.expect)(consoleLogSpy).toHaveBeenCalledWith(vitest_1.expect.stringContaining('✨ [DEBUG:TERMINAL]'), 'terminal message');
        });
        (0, vitest_1.it)('should format webview logs with emoji', () => {
            (0, logger_1.webview)('webview message');
            (0, vitest_1.expect)(consoleLogSpy).toHaveBeenCalledWith(vitest_1.expect.stringContaining('🌐 [DEBUG:WEBVIEW]'), 'webview message');
        });
        (0, vitest_1.it)('should handle object arguments by stringifying them', () => {
            (0, logger_1.info)('data', { a: 1 });
            (0, vitest_1.expect)(consoleLogSpy).toHaveBeenCalledWith('[INFO]', 'data', vitest_1.expect.stringContaining('"a": 1'));
        });
    });
