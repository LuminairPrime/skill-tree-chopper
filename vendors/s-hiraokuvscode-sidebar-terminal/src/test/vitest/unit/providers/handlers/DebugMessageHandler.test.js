...
(0, vitest_1.describe)('DebugMessageHandler', () => {
    ...
    (0, vitest_1.describe)('handleHtmlScriptTest', () => {
        (0, vitest_1.it)('should log debug message with message content', () => {
            ...
            (0, vitest_1.expect)(logger_1.provider).toHaveBeenCalledWith('🔥 [DEBUG] ========== HTML INLINE SCRIPT TEST MESSAGE RECEIVED ==========');
            (0, vitest_1.expect)(logger_1.provider).toHaveBeenCalledWith('🔥 [DEBUG] HTML script communication is working!');
            (0, vitest_1.expect)(logger_1.provider).toHaveBeenCalledWith('🔥 [DEBUG] Message content:', message);
        });
    });
    (0, vitest_1.describe)('handleTimeoutTest', () => {
        (0, vitest_1.it)('should log debug message with message content', () => {
            ...
            (0, vitest_1.expect)(logger_1.provider).toHaveBeenCalledWith('🔥 [DEBUG] ========== HTML TIMEOUT TEST MESSAGE RECEIVED ==========');
            (0, vitest_1.expect)(logger_1.provider).toHaveBeenCalledWith('🔥 [DEBUG] Timeout test communication is working!');
            (0, vitest_1.expect)(logger_1.provider).toHaveBeenCalledWith('🔥 [DEBUG] Message content:', message);
        });
    });
    (0, vitest_1.describe)('handleDebugTest', () => {
        (0, vitest_1.it)('should log init complete when message type is initComplete', () => {
            ...
            (0, vitest_1.expect)(logger_1.provider).toHaveBeenCalledWith('🎆 [TRACE] ===============================');
            (0, vitest_1.expect)(logger_1.provider).toHaveBeenCalledWith('🎆 [TRACE] WEBVIEW CONFIRMS INIT COMPLETE!');
        });
        (0, vitest_1.it)('should log message data when debug is enabled', () => {
            ...
            (0, vitest_1.expect)(logger_1.provider).toHaveBeenCalledWith('🎆 [TRACE] Message data:', message);
        });
        (0, vitest_1.it)('should not log message data when debug is disabled', () => {
            ...
            handler.handleDebugTest(message);
            (0, vitest_1.expect)(logger_1.provider).not.toHaveBeenCalledWith('🎆 [TRACE] Message data:', message);
        });
        (0, vitest_1.it)('should not log anything when message type is not initComplete', () => {
            ...
            handler.handleDebugTest(message);
            (0, vitest_1.expect)(logger_1.provider).not.toHaveBeenCalledWith('🎆 [TRACE] ===============================');
        });
