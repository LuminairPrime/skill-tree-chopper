...
(0, vitest_1.describe)('WebViewInitHandler', () => {
    ...
    (0, vitest_1.describe)('handleWebviewReady', () => {
        ...
        (0, vitest_1.it)('should skip duplicate initialization', () => {
            ...
            const extensionReadyCalls = deps.sendMessage.mock.calls.filter((call) => call[0].command === 'extensionReady');
    ...
    (0, vitest_1.describe)('handleWebviewInitialized', () => {
        (0, vitest_1.it)('should send settings before terminal creation', async () => {
            ...
            (0, vitest_1.expect)(deps.sendMessage).toHaveBeenCalledWith(vitest_1.expect.objectContaining({ command: 'settingsResponse' }));
            (0, vitest_1.expect)(deps.sendMessage).toHaveBeenCalledWith(vitest_1.expect.objectContaining({ command: 'fontSettingsUpdate' }));
        });
        ...
        (0, vitest_1.it)('should reinitialize after panel move when pending', async () => {
            ...
            (0, vitest_1.expect)(deps.sendMessage).toHaveBeenCalledWith(vitest_1.expect.objectContaining({ command: 'init' }));
