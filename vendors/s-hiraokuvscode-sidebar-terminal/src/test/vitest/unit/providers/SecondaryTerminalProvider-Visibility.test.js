...
(0, vitest_1.describe)('SecondaryTerminalProvider - Visibility Guard', () => {
    ...
    (0, vitest_1.describe)('_handleWebviewVisible - panel location detection guard', () => {
        ...
        (0, vitest_1.it)('should skip panel location detection on subsequent visibility restore', () => {
        ...
        (0, vitest_1.it)('should reset flag on dispose (allowing re-detection after reinitialization)', () => {
        ...
        (0, vitest_1.it)('should NOT queue multiple timers when rapid visibility events fire within 200ms', () => {
