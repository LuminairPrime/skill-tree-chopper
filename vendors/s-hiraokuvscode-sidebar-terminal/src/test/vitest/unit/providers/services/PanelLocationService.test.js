...
(0, vitest_1.describe)('PanelLocationService', () => {
    ...
    (0, vitest_1.describe)('handlePanelLocationReport', () => {
        (0, vitest_1.it)('should update cached location and set context', async () => {
            ...
            (0, vitest_1.expect)(vscode.commands.executeCommand).toHaveBeenCalledWith('setContext', 'secondaryTerminal.panelLocation', 'panel');
        });
        ...
        (0, vitest_1.it)('should skip setContext in auto mode but still update cache', async () => {
            ...
            await service.handlePanelLocationReport('panel');
            (0, vitest_1.expect)(service.getCachedPanelLocation()).toBe('panel');
            (0, vitest_1.expect)(vscode.commands.executeCommand).not.toHaveBeenCalledWith('setContext', 'secondaryTerminal.panelLocation', 'panel');
        });
        (0, vitest_1.it)('should prioritize manual panelLocation over reported location', async () => {
            ...
            await service.handlePanelLocationReport('panel');
            (0, vitest_1.expect)(service.getCachedPanelLocation()).toBe('sidebar');
            (0, vitest_1.expect)(vscode.commands.executeCommand).toHaveBeenCalledWith('setContext', 'secondaryTerminal.panelLocation', 'sidebar');
        });
    });
    (0, vitest_1.describe)('requestPanelLocationDetection', () => {
        ...
        (0, vitest_1.it)('should NOT call setContext in error path when panelLocation is auto mode', async () => {
            ...
            (0, vitest_1.expect)(vscode.commands.executeCommand).not.toHaveBeenCalledWith('setContext', 'secondaryTerminal.panelLocation', 'sidebar');
        });
        (0, vitest_1.it)('should NOT call setContext in error path when cached location is already sidebar', async () => {
    ...
    (0, vitest_1.describe)('handlePanelLocationReport - skip redundant setContext', () => {
        ...
        (0, vitest_1.it)('should not trigger onLocationChange callback when location unchanged', async () => {
            const mockGet = vitest_1.vi.fn().mockImplementation((key, def) => {
                if (key === 'panelLocation')
                    return 'panel';
                return def;
        ...
        (0, vitest_1.it)('should skip setContext when first report matches default location', async () => {
            const mockGet = vitest_1.vi.fn().mockImplementation((key, def) => {
                if (key === 'panelLocation')
                    return 'panel';
                return def;
