...
const { mockUnifiedConfig } = vitest_1.vi.hoisted(() => ({
  mockUnifiedConfig: {
    getExtensionTerminalConfig: vitest_1.vi
      .fn()
      .mockReturnValue({ cursorBlink: true, theme: 'auto' }),
    getCompleteTerminalSettings: vitest_1.vi
      .fn()
      .mockReturnValue({ cursorBlink: true, theme: 'auto' }),
    getAltClickSettings: vitest_1.vi
      .fn()
      .mockReturnValue({ altClickMovesCursor: true, multiCursorModifier: 'alt' }),
    getWebViewFontSettings: vitest_1.vi
      .fn()
...
(0, vitest_1.describe)('TerminalEventCoordinator', () => {
  ...
  (0, vitest_1.beforeEach)(() => {
    ...
    coordinator = new TerminalEventCoordinator_1.TerminalEventCoordinator(
      mockTerminalManager,
      mockSendMessage,
      mockSendCliState,
      new Map(),
  ...
  (0, vitest_1.describe)('Terminal Events', () => {
    ...
    (0, vitest_1.it)(
      'should include displayModeOverride when provided on terminal instance',
      () => {
