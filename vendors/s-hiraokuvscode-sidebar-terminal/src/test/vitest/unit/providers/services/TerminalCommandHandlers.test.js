...
(0, vitest_1.describe)('TerminalCommandHandlers', () => {
    ...
    (0, vitest_1.beforeEach)(() => {
        mockTerminalManager = {
            ...
            switchAiAgentConnection: vitest_1.vi.fn().mockReturnValue({ success: true, newStatus: 'connected' }),
        };
        mockCommService = {
    ...
    (0, vitest_1.describe)('Terminal Lifecycle Commands', () => {
        ...
        (0, vitest_1.it)('should handle create terminal', async () => {
            ...
            (0, vitest_1.expect)(mockCommService.sendMessage).toHaveBeenCalledWith(vitest_1.expect.objectContaining({ command: 'stateUpdate' }));
        });
        (0, vitest_1.it)('should handle split terminal', () => {
            handlers.handleSplitTerminal({ command: 'splitTerminal', direction: 'horizontal' });
            (0, vitest_1.expect)(mockTerminalManager.createTerminal).toHaveBeenCalled();
            (0, vitest_1.expect)(mockCommService.sendMessage).toHaveBeenCalledWith(vitest_1.expect.objectContaining({
                command: 'split',
        ...
        (0, vitest_1.it)('should handle kill terminal', async () => {
            ...
            (0, vitest_1.expect)(mockCommService.sendMessage).toHaveBeenCalledWith(vitest_1.expect.objectContaining({ command: 'terminalRemoved' }));
        });
    });
    (0, vitest_1.describe)('Terminal Interaction Commands', () => {
        (0, vitest_1.it)('should handle terminalInteraction switch-next', async () => {
            ...
            (0, vitest_1.expect)(mockTerminalManager.setActiveTerminal).toHaveBeenCalledWith('t2');
            (0, vitest_1.expect)(mockCommService.sendMessage).toHaveBeenCalledWith(vitest_1.expect.objectContaining({ command: 'focusTerminal', terminalId: 't2' }));
            (0, vitest_1.expect)(mockCommService.sendMessage).toHaveBeenCalledWith(vitest_1.expect.objectContaining({ command: 'stateUpdate' }));
        });
        (0, vitest_1.it)('should handle terminalInteraction switch-previous', async () => {
            ...
            (0, vitest_1.expect)(mockCommService.sendMessage).toHaveBeenCalledWith(vitest_1.expect.objectContaining({ command: 'focusTerminal', terminalId: 't3' }));
            (0, vitest_1.expect)(mockCommService.sendMessage).toHaveBeenCalledWith(vitest_1.expect.objectContaining({ command: 'stateUpdate' }));
        });
        ...
        (0, vitest_1.it)('should handle terminalInteraction kill-terminal', async () => {
            ...
            (0, vitest_1.expect)(mockTerminalManager.killTerminal).toHaveBeenCalledWith('t1');
            (0, vitest_1.expect)(mockCommService.sendMessage).toHaveBeenCalledWith(vitest_1.expect.objectContaining({ command: 'terminalRemoved', terminalId: 't1' }));
            (0, vitest_1.expect)(mockCommService.sendMessage).toHaveBeenCalledWith(vitest_1.expect.objectContaining({ command: 'stateUpdate' }));
        });
        (0, vitest_1.it)('should use the active terminal when terminalInteraction kill-terminal omits terminalId', async () => {
            ...
            (0, vitest_1.expect)(mockCommService.sendMessage).toHaveBeenCalledWith(vitest_1.expect.objectContaining({ command: 'terminalRemoved', terminalId: 't2' }));
        });
        (0, vitest_1.it)('should fall back to message terminalId when active terminal is unavailable during navigation', async () => {
            mockTerminalManager.getTerminals.mockReturnValue([{ id: 't1' }, { id: 't2' }, { id: 't3' }]);
        ...
        (0, vitest_1.it)('should handle rename terminal and send state update', async () => {
            ...
            (0, vitest_1.expect)(mockTerminalManager.renameTerminal).toHaveBeenCalledWith('t1', 'Renamed Terminal');
            (0, vitest_1.expect)(mockCommService.sendMessage).toHaveBeenCalledWith(vitest_1.expect.objectContaining({ command: 'stateUpdate' }));
        });
        ...
        (0, vitest_1.it)('should normalize lowercase hex indicator colors before updating terminal header', async () => {
            await handlers.handleUpdateTerminalHeader({
                command: 'updateTerminalHeader',
                terminalId: 't1',
                indicatorColor: '#ff69b4',
        ...
        (0, vitest_1.it)('should fall back to renameTerminal when updateTerminalHeader is unavailable', async () => {
            ...
            (0, vitest_1.expect)(mockTerminalManager.renameTerminal).toHaveBeenCalledWith('t1', 'Agent Terminal');
            (0, vitest_1.expect)(mockCommService.sendMessage).toHaveBeenCalledWith(vitest_1.expect.objectContaining({ command: 'stateUpdate' }));
        });
        (0, vitest_1.it)('should ignore update terminal header when all provided updates are invalid', async () => {
            await handlers.handleUpdateTerminalHeader({
                command: 'updateTerminalHeader',
                terminalId: 't1',
                newName: '   ',
    ...
    (0, vitest_1.describe)('Clipboard Commands', () => {
        (0, vitest_1.it)('should handle clipboard request (paste)', async () => {
            ...
            (0, vitest_1.expect)(mockTerminalManager.sendInput).toHaveBeenCalledWith('\x1b[200~clipboard content\x1b[201~', 't1');
        });
    ...
    (0, vitest_1.describe)('Other Commands', () => {
        ...
        (0, vitest_1.it)('should handle AI agent switch', async () => {
            ...
            (0, vitest_1.expect)(mockCommService.sendMessage).toHaveBeenCalledWith(vitest_1.expect.objectContaining({ command: 'switchAiAgentResponse' }));
        });
    });
});
