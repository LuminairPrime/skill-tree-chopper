...
(0, vitest_1.describe)('WebViewCommunicationService', () => {
    ...
    (0, vitest_1.describe)('Message Sending', () => {
        ...
        (0, vitest_1.it)('should queue messages if view is not available and flush when set', async () => {
        ...
        (0, vitest_1.it)('should handle disposed webview error gracefully', async () => {
            ...
            const { TerminalErrorHandler } = await Promise.resolve().then(() => require('../../../../../utils/feedback'));
