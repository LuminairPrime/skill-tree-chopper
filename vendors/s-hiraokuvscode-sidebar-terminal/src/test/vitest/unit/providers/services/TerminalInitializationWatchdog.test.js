...
(0, vitest_1.describe)('TerminalInitializationWatchdog', () => {
    ...
    (0, vitest_1.it)('should trigger callback after initial delay', () => {
        ...
        (0, vitest_1.expect)(mockCallback).toHaveBeenCalledWith(terminalId, { attempt: 1, isFinalAttempt: false });
    });
    ...
    (0, vitest_1.it)('should stop after max attempts', () => {
        ...
        (0, vitest_1.expect)(mockCallback).toHaveBeenLastCalledWith(terminalId, { attempt: 3, isFinalAttempt: true });
