...
(0, vitest_1.describe)('InitializationOrchestrator', () => {
  ...
  (0, vitest_1.beforeEach)(() => {
    ...
    orchestrator = new InitializationOrchestrator_1.InitializationOrchestrator(
      mockTerminalCoordinator,
  ...
  (0, vitest_1.describe)('Initial State', () => {
    (0, vitest_1.it)('should start in NOT_STARTED phase', () => {
      (0, vitest_1.expect)(orchestrator.getCurrentPhase()).toBe(
        InitializationOrchestrator_1.InitializationPhase.NOT_STARTED
      );
  ...
  (0, vitest_1.describe)('initialize', () => {
    (0, vitest_1.it)('should complete all phases successfully', async () => {
      ...
      (0, vitest_1.expect)(result.phase).toBe(
        InitializationOrchestrator_1.InitializationPhase.COMPLETED
      );
    ...
    (0, vitest_1.it)('should track phase timings', async () => {
      ...
      (0, vitest_1.expect)(
        timings.has(InitializationOrchestrator_1.InitializationPhase.WEBVIEW_SETUP)
      ).toBe(true);
      (0, vitest_1.expect)(
        timings.has(InitializationOrchestrator_1.InitializationPhase.MESSAGE_HANDLERS)
      ).toBe(true);
      (0, vitest_1.expect)(
        timings.has(InitializationOrchestrator_1.InitializationPhase.TERMINAL_SETUP)
      ).toBe(true);
    ...
    (0, vitest_1.it)('should handle phase failure gracefully', async () => {
      ...
      (0, vitest_1.expect)(result.phase).toBe(
        InitializationOrchestrator_1.InitializationPhase.FAILED
      );
