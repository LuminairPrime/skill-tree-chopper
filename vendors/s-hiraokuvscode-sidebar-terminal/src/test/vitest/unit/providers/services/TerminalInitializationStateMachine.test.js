...
(0, vitest_1.describe)('TerminalInitializationStateMachine', () => {
  ...
  (0, vitest_1.describe)('Initial State', () => {
    (0, vitest_1.it)('should return Idle state for unknown terminal', () => {
      (0, vitest_1.expect)(stateMachine.getState('unknown')).toBe(
        TerminalInitializationStateMachine_1.TerminalInitializationState.Idle
      );
    });
  ...
  (0, vitest_1.describe)('State Transitions', () => {
    (0, vitest_1.it)('should transition through states sequentially', () => {
      ...
      (0, vitest_1.expect)(stateMachine.getState(terminalId)).toBe(
        TerminalInitializationStateMachine_1.TerminalInitializationState.ViewPending
      );
      stateMachine.markViewReady(terminalId);
      (0, vitest_1.expect)(stateMachine.getState(terminalId)).toBe(
        TerminalInitializationStateMachine_1.TerminalInitializationState.ViewReady
      );
      stateMachine.markPtySpawned(terminalId);
      (0, vitest_1.expect)(stateMachine.getState(terminalId)).toBe(
        TerminalInitializationStateMachine_1.TerminalInitializationState.PtySpawned
      );
    });
    ...
    (0, vitest_1.it)('should allow regression to Failed state', () => {
      ...
      (0, vitest_1.expect)(stateMachine.getState(terminalId)).toBe(
        TerminalInitializationStateMachine_1.TerminalInitializationState.Failed
      );
    });
  });
