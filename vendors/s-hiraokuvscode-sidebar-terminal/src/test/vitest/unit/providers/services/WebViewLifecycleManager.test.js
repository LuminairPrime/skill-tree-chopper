...
(0, vitest_1.describe)('WebViewLifecycleManager', () => {
    ...
    (0, vitest_1.describe)('Configuration', () => {
        (0, vitest_1.it)('should configure webview options', () => {
            ...
            (0, vitest_1.expect)(mockWebviewView.webview.options.localResourceRoots).toContain(mockContext.extensionUri);
        });
    });
    (0, vitest_1.describe)('HTML Setting', () => {
        ...
        (0, vitest_1.it)('should handle setup error gracefully', () => {
            ...
            (0, vitest_1.expect)(mockHtmlService.generateErrorHtml).toHaveBeenCalledWith(vitest_1.expect.objectContaining({ error }));
        });
    });
