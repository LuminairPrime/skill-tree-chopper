...
(0, vitest_1.describe)('SecondaryTerminalProvider - Dynamic Split Direction (Issue #148)', function () {
    ...
    (0, vitest_1.beforeEach)(function () {
        ...
        mockWebview = {
            ...
            asWebviewUri: vitest_1.vi.fn().mockReturnValue({ toString: () => 'file:///test/webview.js' }),
    ...
    (0, vitest_1.describe)('Panel Location Detection', function () {
        (0, vitest_1.it)('should set initial context key to sidebar on webview setup', async function () {
            // Act
            mockProvider.resolveWebviewView(mockWebviewView);
            // Wait for async operations
            await new Promise((resolve) => setTimeout(resolve, 10));
            // Assert
            (0, vitest_1.expect)(executeCommandMock).toHaveBeenCalledWith('setContext', 'secondaryTerminal.panelLocation', 'sidebar');
        });
        (0, vitest_1.it)('should request panel location detection on getSettings', async function () {
            ...
            (0, vitest_1.expect)(postMessageMock).toHaveBeenCalledWith(vitest_1.expect.objectContaining({
                command: 'panelLocationUpdate',
                location: 'sidebar',
            }));
            (0, vitest_1.expect)(postMessageMock).toHaveBeenCalledWith(vitest_1.expect.objectContaining({
        ...
        (0, vitest_1.it)('should update context key when WebView reports panel location', async function () {
            // Arrange
            mockProvider.resolveWebviewView(mockWebviewView);
            // Act
            ...
            // Assert
            (0, vitest_1.expect)(executeCommandMock).toHaveBeenCalledWith('setContext', 'secondaryTerminal.panelLocation', 'panel');
            (0, vitest_1.expect)(postMessageMock).toHaveBeenCalledWith(vitest_1.expect.objectContaining({
                command: 'panelLocationUpdate',
                location: 'panel',
            }));
    ...
    (0, vitest_1.describe)('Split Command Integration', function () {
        ...
        (0, vitest_1.it)('should auto-determine horizontal split when in sidebar and no direction specified', function () {
            // Arrange
            mockTerminalManager.getTerminals.mockReturnValue([]);
            mockTerminalManager.createTerminal.mockReturnValue('terminal-1');
        ...
        (0, vitest_1.it)('should auto-determine vertical split when in panel and no direction specified', function () {
            // Arrange
            mockTerminalManager.getTerminals.mockReturnValue([]);
            mockTerminalManager.createTerminal.mockReturnValue('terminal-1');
        ...
        (0, vitest_1.it)('should use horizontal split when dynamicSplitDirection is disabled', function () {
            // Arrange
            mockTerminalManager.getTerminals.mockReturnValue([]);
            mockTerminalManager.createTerminal.mockReturnValue('terminal-1');
    ...
    (0, vitest_1.describe)('Panel Location Change Handling', function () {
        ...
        (0, vitest_1.it)('should request panel location detection on visibility change', async function () {
            // Arrange
            const onDidChangeVisibilityMock = vitest_1.vi.mocked(mockWebviewView.onDidChangeVisibility);
        ...
        (0, vitest_1.it)('should handle configuration changes for panel location settings', async function () {
    ...
    (0, vitest_1.describe)('Error Handling', function () {
        ...
        (0, vitest_1.it)('should handle reportPanelLocation message without location gracefully', async function () {
            ...
            const setContextCalls = executeCommandMock.mock.calls.filter((call) => call[0] === 'setContext' && call[1] === 'secondaryTerminal.panelLocation');
        ...
        (0, vitest_1.it)('should set fallback context key when panel detection fails', async function () {
            // Arrange
    ...
    (0, vitest_1.describe)('Integration with VS Code Commands', function () {
        ...
        (0, vitest_1.it)('should maintain context key state across webview reloads', async function () {
            // Arrange
            mockProvider.resolveWebviewView(mockWebviewView);
            await mockProvider._handleWebviewMessage({
                command: 'reportPanelLocation',
    ...
    (0, vitest_1.describe)('Performance Considerations', function () {
        ...
        (0, vitest_1.it)('should not spam context key updates for rapid panel location changes', async function () {
            // Arrange
