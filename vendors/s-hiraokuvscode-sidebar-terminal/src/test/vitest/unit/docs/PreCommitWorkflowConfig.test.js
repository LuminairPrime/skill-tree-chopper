...
(0, vitest_1.describe)('Pre-commit workflow configuration (#272)', () => {
    ...
    (0, vitest_1.it)('uses external lint-staged config file instead of package.json key', () => {
        ...
        (0, vitest_1.expect)(fs_1.default.existsSync(path_1.default.join(repoRoot, 'lint-staged.config.cjs'))).toBe(true);
    });
    ...
    (0, vitest_1.it)('lint-staged uses function form for TypeScript to avoid file path appending', () => {
