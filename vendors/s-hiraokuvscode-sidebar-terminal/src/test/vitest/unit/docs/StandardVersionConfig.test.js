...
const readText = (relativePath) => fs_1.default.readFileSync(path_1.default.join(repoRoot, relativePath), 'utf8');
...
(0, vitest_1.describe)('standard-version configuration (#273)', () => {
    ...
    (0, vitest_1.describe)('.versionrc.cjs existence and structure', () => {
        (0, vitest_1.it)('has .versionrc.cjs at the repository root', () => {
            (0, vitest_1.expect)(fs_1.default.existsSync(path_1.default.join(repoRoot, '.versionrc.cjs'))).toBe(true);
        });
    ...
    (0, vitest_1.describe)('commands/release.js', () => {
        (0, vitest_1.it)('exists at the repository root', () => {
            (0, vitest_1.expect)(fs_1.default.existsSync(path_1.default.join(repoRoot, 'commands/release.js'))).toBe(true);
        });
    });
});
