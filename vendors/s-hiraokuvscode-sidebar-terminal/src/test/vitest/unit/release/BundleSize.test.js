...
const expectDistFile = (fileName) => {
  ...
  (0, vitest_1.expect)(node_fs_1.default.existsSync(artifactPath), `${fileName} should exist`).toBe(
    true
  );
...
describeIfBuilt('webview release bundle artifacts', () => {
  ...
  (0, vitest_1.it)('does not ship the obsolete webview-simple build artifact', () => {
    (0, vitest_1.expect)(node_fs_1.default.existsSync(getDistPath('webview-simple.js'))).toBe(
      false
    );
    (0, vitest_1.expect)(node_fs_1.default.existsSync(getDistPath('webview-simple.js.map'))).toBe(
      false
    );
  });
