...
(0, vitest_1.describe)('IntegratedSecondaryTerminalProvider', () => {
    ...
    beforeEach(() => {
        ...
        provider = new IntegratedSecondaryTerminalProvider_1.IntegratedSecondaryTerminalProvider(mockContext, mockTerminalManager);
        mockWebviewView = {
            webview: {
                options: {},
                html: '',
    ...
    (0, vitest_1.describe)('message handling', () => {
        ...
        (0, vitest_1.it)('should handle webviewReady and send settings', async () => {
            ...
            (0, vitest_1.expect)(mockWebviewView.webview.postMessage).toHaveBeenCalledWith(vitest_1.expect.objectContaining({ command: 'settingsResponse' }));
        });
        (0, vitest_1.it)('should handle createTerminal', async () => {
            ...
            (0, vitest_1.expect)(mockWebviewView.webview.postMessage).toHaveBeenCalledWith(vitest_1.expect.objectContaining({ command: 'terminalCreated', terminalId: 'new-id' }));
        });
    ...
    (0, vitest_1.describe)('event listeners', () => {
        ...
        (0, vitest_1.it)('should forward state updates to webview', () => {
            ...
            (0, vitest_1.expect)(mockWebviewView.webview.postMessage).toHaveBeenCalledWith(vitest_1.expect.objectContaining({ command: 'stateUpdate', state: mockState }));
        });
    });
