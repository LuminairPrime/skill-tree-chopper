...
(0, vitest_1.describe)('Input Optimization Integration', () => {
  ...
  (0, vitest_1.describe)('End-to-End Input Flow', () => {
    ...
    vitest_1.it.skip('should handle high-priority input messages correctly', async () => {
      ...
      (0, vitest_1.expect)(executionOrder.slice(0, 2)).toEqual([
        'input-none',
        'terminalInteraction-paste',
      ]);
    });
    ...
    (0, vitest_1.it)(
      'should recover IME state when compositionend is missing and focus/context changes',
      () => {
        // Start IME composition and intentionally skip compositionend
        document.dispatchEvent(
          new jsdom.window.CompositionEvent('compositionstart', { data: 'に' })
        );
        (0, vitest_1.expect)(inputManager.isIMEComposing()).toBe(true);
        ...
        document.dispatchEvent(
          new jsdom.window.CompositionEvent('compositionstart', { data: 'ほ' })
        );
        (0, vitest_1.expect)(inputManager.isIMEComposing()).toBe(true);
  ...
  (0, vitest_1.describe)('Performance Benchmarks', () => {
    ...
    (0, vitest_1.it)(
      'should process 1000 rapid inputs without significant delay accumulation',
      () => {
        const startTime = Date.now();
    ...
    (0, vitest_1.it)('should handle mixed input sizes efficiently', () => {
      ...
      (0, vitest_1.expect)(
        mockTerminal.write.mock.calls.length - beforeCount
  ...
  (0, vitest_1.describe)('Memory and Resource Management', () => {
    vitest_1.it.skip('should properly cleanup all managers without memory leaks', () => {
      ...
      (0, vitest_1.expect)(
        messageStats.queueSize + (messageStats.highPriorityQueueSize || 0)
      ).toBeGreaterThan(0);
