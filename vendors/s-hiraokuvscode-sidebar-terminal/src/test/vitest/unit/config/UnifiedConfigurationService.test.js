...
(0, vitest_1.describe)('UnifiedConfigurationService', () => {
  ...
  (0, vitest_1.beforeEach)(() => {
    ...
    try {
      const existingInstance =
        UnifiedConfigurationService_1.UnifiedConfigurationService.getInstance();
  ...
  (0, vitest_1.describe)('Configuration Update', () => {
    (0, vitest_1.it)('should update configuration values', async () => {
      ...
      (0, vitest_1.expect)(mockWorkspaceConfiguration.update).toHaveBeenCalledWith(
        'fontSize',
        16,
    ...
    (0, vitest_1.it)('should clear cache after update', async () => {
      ...
      (0, vitest_1.expect)(mockWorkspaceConfiguration.get.mock.calls.length).toBe(
        callCountAfterCache
      );
      ...
      (0, vitest_1.expect)(mockWorkspaceConfiguration.get.mock.calls.length).toBeGreaterThan(
    ...
    (0, vitest_1.it)('should fire configuration change event', async () => {
      ...
      (0, vitest_1.expect)(
        changeEvent.affectsConfiguration('terminal.integrated', 'fontSize')
      ).toBe(true);
  ...
  (0, vitest_1.describe)('Extension Terminal Configuration', () => {
    (0, vitest_1.beforeEach)(() => {
      ...
      mockWorkspaceConfiguration.get.mockImplementation((key, defaultValue) => {
        if (key === shared_1.CONFIG_KEYS.MAX_TERMINALS) return 5;
        if (key === shared_1.CONFIG_KEYS.SHELL) return '/bin/bash';
        if (key === shared_1.CONFIG_KEYS.SHELL_ARGS) return ['-l'];
        if (key === shared_1.CONFIG_KEYS.DEFAULT_DIRECTORY) return '/home/user';
        if (key === shared_1.CONFIG_KEYS.CURSOR_BLINK) return true;
    ...
    (0, vitest_1.it)('should get complete terminal settings', () => {
      ...
      mockWorkspaceConfiguration.get.mockImplementation((key, defaultValue) => {
        if (key === shared_1.CONFIG_KEYS.THEME) return 'dark';
        if (key === shared_1.CONFIG_KEYS.CONFIRM_BEFORE_KILL) return false;
        if (key === shared_1.CONFIG_KEYS.PROTECT_LAST_TERMINAL) return true;
        if (key === shared_1.CONFIG_KEYS.MIN_TERMINAL_COUNT) return 1;
        return defaultValue;
      });
      ...
      vscode.workspace.getConfiguration.mockImplementation((section) => {
        ...
        if (section === shared_1.CONFIG_SECTIONS.EDITOR) return editorConfig;
        return mockWorkspaceConfiguration;
      });
      terminalIntegratedConfig.get.mockImplementation((key, defaultValue) => {
        if (key === shared_1.CONFIG_KEYS.ALT_CLICK_MOVES_CURSOR) return true;
        return defaultValue;
      });
      editorConfig.get.mockImplementation((key, defaultValue) => {
        if (key === shared_1.CONFIG_KEYS.MULTI_CURSOR_MODIFIER) return 'alt';
        return defaultValue;
      });
  ...
  (0, vitest_1.describe)('WebView Configuration', () => {
    (0, vitest_1.it)('should get WebView terminal settings', () => {
      mockWorkspaceConfiguration.get.mockImplementation((key, defaultValue) => {
        ...
        if (key === shared_1.CONFIG_KEYS.MAX_TERMINALS) return 3;
        if (key === shared_1.CONFIG_KEYS.CURSOR_BLINK) return false;
  ...
  (0, vitest_1.describe)('Platform-Specific Shell Configuration', () => {
    ...
    (0, vitest_1.it)('should get Windows shell configuration', () => {
      ...
      terminalIntegratedConfig.get.mockImplementation((key) => {
        if (key === shared_1.CONFIG_KEYS.SHELL_WINDOWS) return 'powershell.exe';
        return undefined;
      });
    ...
    (0, vitest_1.it)('should get macOS shell configuration', () => {
      ...
      terminalIntegratedConfig.get.mockImplementation((key) => {
        if (key === shared_1.CONFIG_KEYS.SHELL_OSX) return '/bin/zsh';
        return undefined;
      });
      const shell = service.getShellForPlatform();
    ...
    (0, vitest_1.it)('should get Linux shell configuration', () => {
      ...
      terminalIntegratedConfig.get.mockImplementation((key) => {
        if (key === shared_1.CONFIG_KEYS.SHELL_LINUX) return '/bin/bash';
        return undefined;
      });
      const shell = service.getShellForPlatform();
    ...
    (0, vitest_1.it)('should use environment variables as fallback', () => {
      ...
      terminalIntegratedConfig.get.mockImplementation((key) => {
        if (key === shared_1.CONFIG_KEYS.SHELL_LINUX) return '';
        return undefined;
      });
      const shell = service.getShellForPlatform();
  ...
  (0, vitest_1.describe)('Feature Enablement', () => {
    (0, vitest_1.beforeEach)(() => {
      ...
      const editorConfig = { get: vitest_1.vi.fn() };
      vscode.workspace.getConfiguration.mockImplementation((section) => {
        if (section === shared_1.CONFIG_SECTIONS.SIDEBAR_TERMINAL) return sidebarConfig;
        if (section === shared_1.CONFIG_SECTIONS.TERMINAL_INTEGRATED)
          return terminalIntegratedConfig;
        if (section === shared_1.CONFIG_SECTIONS.EDITOR) return editorConfig;
        return mockWorkspaceConfiguration;
  ...
  (0, vitest_1.describe)('Configuration Profiles', () => {
    (0, vitest_1.it)('should get terminal profiles configuration', () => {
      mockWorkspaceConfiguration.get.mockImplementation((key, defaultValue) => {
        ...
        if (key === shared_1.CONFIG_KEYS.PROFILES_LINUX) return { Bash: { path: '/bin/bash' } };
        if (key === shared_1.CONFIG_KEYS.PROFILES_OSX) return { Zsh: { path: '/bin/zsh' } };
        if (key === shared_1.CONFIG_KEYS.DEFAULT_PROFILE_WINDOWS) return 'PowerShell';
        if (key === shared_1.CONFIG_KEYS.DEFAULT_PROFILE_LINUX) return 'Bash';
        if (key === shared_1.CONFIG_KEYS.DEFAULT_PROFILE_OSX) return 'Zsh';
        if (key === shared_1.CONFIG_KEYS.ENABLE_PROFILE_AUTO_DETECTION) return false;
        if (key === shared_1.CONFIG_KEYS.INHERIT_VSCODE_PROFILES) return true;
        return defaultValue;
      });
  ...
  (0, vitest_1.describe)('Event Handling', () => {
    (0, vitest_1.it)('should emit configuration change events', async () => {
      ...
      (0, vitest_1.expect)(
        eventResult.affectsConfiguration('terminal.integrated', 'fontSize')
      ).toBe(true);
  ...
  (0, vitest_1.describe)('Error Handling', () => {
    ...
    (0, vitest_1.it)('should handle configuration update errors', async () => {
      ...
      await (0, vitest_1.expect)(
        service.update('terminal.integrated', 'fontSize', 16)
  ...
  (0, vitest_1.describe)('Backward Compatibility', () => {
    (0, vitest_1.it)('should provide legacy getConfigManager function', () => {
      ...
      (0, vitest_1.expect)(legacyManager).toBeInstanceOf(
        UnifiedConfigurationService_1.UnifiedConfigurationService
      );
    });
