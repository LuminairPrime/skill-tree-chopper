...
(0, vitest_1.describe)('MessageRouter Service', () => {
    ...
    (0, vitest_1.describe)('Handler Registration', () => {
        ...
        (0, vitest_1.it)('should register multiple handlers', () => {
            ...
            (0, vitest_1.expect)(messageRouter.getRegisteredCommands()).toEqual(vitest_1.expect.arrayContaining(['command1', 'command2', 'command3']));
        });
    ...
    (0, vitest_1.describe)('Concurrency Management', () => {
        (0, vitest_1.it)('should enforce concurrent handler limits', async () => {
            ...
            const concurrencyFailures = failures.filter((r) => r.error?.includes('Maximum concurrent handlers reached'));
    ...
    (0, vitest_1.describe)('BaseMessageHandler', () => {
        ...
        (0, vitest_1.it)('should log messages with handler name', () => {
            ...
            (0, vitest_1.expect)(consoleLogSpy.mock.calls.some((args) => args.includes('[TestHandler] Handler executed'))).toBe(true);
        });
