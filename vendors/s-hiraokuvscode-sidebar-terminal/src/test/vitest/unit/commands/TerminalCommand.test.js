...
(0, vitest_1.describe)('TerminalCommand', () => {
    ...
    (0, vitest_1.describe)('handleSendToTerminal', () => {
        (0, vitest_1.it)('should send provided content directly', () => {
            ...
            (0, vitest_1.expect)(mockTerminalManager.sendInput).toHaveBeenCalledWith('echo hello', 'term-1');
        });
        (0, vitest_1.it)('should show input box if no content provided', async () => {
            ...
            (0, vitest_1.expect)(mockTerminalManager.sendInput).toHaveBeenCalledWith('user-input', 'term-1');
        });
        ...
        (0, vitest_1.it)('should handle errors gracefully', () => {
            ...
            command.handleSendToTerminal('hello');
            (0, vitest_1.expect)(vscode.window.showErrorMessage).toHaveBeenCalledWith(vitest_1.expect.stringContaining('Send failed'));
        });
    });
});
