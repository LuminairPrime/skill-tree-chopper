...
(0, vitest_1.describe)('FileReferenceCommand', () => {
  ...
  (0, vitest_1.describe)('handleSendAtMention', () => {
    (0, vitest_1.it)(
      'should send file reference without line numbers when no selection',
      async () => {
    ...
    (0, vitest_1.it)(
      'should send file reference with line numbers when text is selected',
      async () => {
        // Mock selection
        mockSelection.isEmpty = false;
        mockSelection.start = { line: 2 }; // 0-based
    ...
    (0, vitest_1.describe)('terminal focus behavior', () => {
      (0, vitest_1.it)(
        'should send to focused terminal directly when terminal has focus, even without connected agent',
        async () => {
      ...
      (0, vitest_1.it)(
        'should send to focused terminal (not connected agent terminal) when terminal has focus',
        async () => {
      ...
      (0, vitest_1.it)(
        'should fall back to connected agent behavior when editor has focus',
        async () => {
      ...
      (0, vitest_1.it)(
        'should not focus the sidebar view before sending when editor has focus',
        async () => {
          mockTerminalManager.isTerminalFocused = vitest_1.vi.fn().mockReturnValue(false);
          mockTerminalManager.getConnectedAgents.mockReturnValue([
            { terminalId: 'terminal-1', agentInfo: { type: 'claude' } },
  ...
  (0, vitest_1.describe)('handleSendAllOpenFiles', () => {
    ...
    (0, vitest_1.it)(
      'should not focus the sidebar view before sending all open files when editor has focus',
      async () => {
        mockTerminalManager.isTerminalFocused = vitest_1.vi.fn().mockReturnValue(false);
        mockTerminalManager.getConnectedAgents.mockReturnValue([
          { terminalId: 'terminal-1', agentInfo: { type: 'claude' } },
