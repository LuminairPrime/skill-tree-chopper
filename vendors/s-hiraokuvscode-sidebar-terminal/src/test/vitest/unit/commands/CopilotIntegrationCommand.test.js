...
(0, vitest_1.describe)('CopilotIntegrationCommand', () => {
    ...
    (0, vitest_1.describe)('handleActivateCopilot', () => {
        ...
        (0, vitest_1.it)('should activate Copilot Chat and send file reference when file is open', () => {
            copilotIntegrationCommand.handleActivateCopilot();
            (0, vitest_1.expect)(vscode.commands.executeCommand).toHaveBeenCalledWith('workbench.action.chat.open', {
                query: '#file:src/test.ts  ',
                isPartialQuery: true,
            });
        });
        (0, vitest_1.it)('should activate Copilot Chat without file reference when no file is open', () => {
        ...
        (0, vitest_1.it)('should show information message when integration is disabled', () => {
            ...
            vscode.workspace.getConfiguration.mockReturnValue(mockConfig);
            copilotIntegrationCommand.handleActivateCopilot();
            (0, vitest_1.expect)(vscode.window.showInformationMessage).toHaveBeenCalledWith('GitHub Copilot integration is disabled. Enable it in Terminal Settings.');
        ...
        (0, vitest_1.it)('should handle command execution errors gracefully', async () => {
            ...
            await (0, vitest_1.expect)(copilotIntegrationCommand.handleActivateCopilot()).resolves.not.toThrow();
    ...
    (0, vitest_1.describe)('formatCopilotFileReference', () => {
        ...
        (0, vitest_1.it)('should format file reference with #file: prefix for multi-line selection', () => {
            const fileInfo = {
                relativePath: 'src/test.ts',
                selection: {
                    startLine: 3,
