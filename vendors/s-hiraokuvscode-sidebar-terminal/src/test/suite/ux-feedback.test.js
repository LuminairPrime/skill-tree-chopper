    ...
    test('Error messages should be user-friendly', () => {
        ...
        try {
            ...
            if (errorMessageShown) {
                ...
                assert.ok(!errorMessage.includes('undefined'), 'Error message should not contain "undefined"');
                assert.ok(!errorMessage.includes('null'), 'Error message should not contain "null"');
                assert.ok(!errorMessage.includes('[object Object]'), 'Error message should not contain object representation');
            }
        }
        finally {
    ...
    test('Warning messages should be informative', () => {
        ...
        try {
            ...
            if (warningMessageShown) {
                ...
                assert.ok(warningMessage.includes('maximum') ||
                    warningMessage.includes('limit') ||
                    warningMessage.includes('Maximum'), 'Warning should mention limits or maximum');
            }
        }
        finally {
            // Restore original method
...
//# sourceMappingURL=ux-feedback.test.js.map