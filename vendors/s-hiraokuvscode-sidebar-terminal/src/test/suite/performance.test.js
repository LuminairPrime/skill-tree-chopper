...
suite('Performance Test Suite', () => {
    ...
    test('Memory usage should be reasonable', () => {
        ...
        assert.ok(memoryIncrease < maxMemoryIncrease, `Memory increased by ${memoryIncrease / 1024 / 1024}MB, should be < 50MB`);
    });
    ...
    test('Event handling should not cause memory leaks', () => {
        ...
        assert.ok(memoryIncrease < maxMemoryIncrease, `Event handling increased memory by ${memoryIncrease / 1024 / 1024}MB, should be < 10MB`);
