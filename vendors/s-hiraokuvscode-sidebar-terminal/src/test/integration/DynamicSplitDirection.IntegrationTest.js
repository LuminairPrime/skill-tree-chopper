...
(0, mocha_1.describe)('Dynamic Split Direction - Integration Tests', function () {
    ...
    (0, mocha_1.describe)('End-to-End Panel Location Detection Flow', function () {
        (0, mocha_1.it)('should complete full sidebar detection cycle', async function () {
            ...
            (0, chai_1.expect)(executeCommandStub).to.have.been.calledWith('setContext', 'secondaryTerminal.panelLocation', 'sidebar');
            (0, chai_1.expect)(postMessageStub).to.have.been.calledWith(sinon.match({
        ...
        (0, mocha_1.it)('should complete full panel detection cycle', async function () {
            ...
            // Assert
            (0, chai_1.expect)(executeCommandStub).to.have.been.calledWith('setContext', 'secondaryTerminal.panelLocation', 'panel');
            (0, chai_1.expect)(postMessageStub).to.have.been.calledWith(sinon.match({
                command: 'panelLocationUpdate',
                location: 'panel',
            }));
    ...
    (0, mocha_1.describe)('Error Recovery Integration', function () {
        ...
        (0, mocha_1.it)('should recover from WebView communication failures', async function () {
            ...
            (0, chai_1.expect)(executeCommandStub).to.have.been.calledWith('setContext', 'secondaryTerminal.panelLocation', 'sidebar' // Should fallback to sidebar
            );
        });
    ...
    (0, mocha_1.describe)('Performance Integration', function () {
        ...
        (0, mocha_1.it)('should handle rapid panel location changes efficiently', async function () {
            ...
            (0, chai_1.expect)(executeCommandStub.lastCall).to.have.been.calledWith('setContext', 'secondaryTerminal.panelLocation', 'sidebar');
        });
        (0, mocha_1.it)('should not degrade performance with multiple terminals and frequent moves', async function () {
    ...
    (0, mocha_1.describe)('VS Code Integration', function () {
        (0, mocha_1.it)('should properly integrate with VS Code command system', async function () {
            ...
            (0, chai_1.expect)(executeCommandStub).to.have.been.calledWith('setContext', sinon.match.string, sinon.match.string);
            // Check that the context key is set correctly for VS Code when clauses
            const contextCalls = executeCommandStub
                .getCalls()
                .filter((call) => call.args[0] === 'setContext' && call.args[1] === 'secondaryTerminal.panelLocation');
