...
class ConsolidatedMessageService {
    ...
    emitTerminalInteractionEvent(type, terminalId, data, coordinator) {
        ...
        this.dispatcher.sendTerminalInteractionEvent(type, terminalId, data, UnifiedMessageDispatcher_1.MessagePriority.NORMAL);
    ...
    sendResize(cols, rows, terminalId, coordinator) {
        ...
        this.dispatcher.sendResize(cols, rows, terminalId, UnifiedMessageDispatcher_1.MessagePriority.HIGH);
    ...
    sendDeleteTerminalMessage(terminalId, requestSource, coordinator) {
        ...
        this.dispatcher.sendDeleteTerminalMessage(terminalId, requestSource, UnifiedMessageDispatcher_1.MessagePriority.HIGH);
