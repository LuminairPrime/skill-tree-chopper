  ...
  activate(context) {
    ...
    try {
      ...
      this.extensionPersistenceService =
        new ExtensionPersistenceService_1.ExtensionPersistenceService(
          context,
      ...
      try {
        this.shellIntegrationService =
          new EnhancedShellIntegrationService_1.EnhancedShellIntegrationService(
            this.terminalManager,
            context
          );
      ...
      this.sidebarProvider = new SecondaryTerminalProvider_1.SecondaryTerminalProvider(
        context,
        this.terminalManager,
        this.extensionPersistenceService,
      ...
      this.keyboardShortcutService = new KeyboardShortcutService_1.KeyboardShortcutService(
        this.terminalManager
      );
      ...
      const sidebarWebviewProvider = vscode.window.registerWebviewViewProvider(
        SecondaryTerminalProvider_1.SecondaryTerminalProvider.viewType,
  ...
  setupTelemetryEventListeners() {
    ...
    if (this.extensionPersistenceService) {
      ...
      (0, logger_1.extension)(
        '📊 [TELEMETRY] Session manager event tracking (to be implemented if events available)'
      );
    }
