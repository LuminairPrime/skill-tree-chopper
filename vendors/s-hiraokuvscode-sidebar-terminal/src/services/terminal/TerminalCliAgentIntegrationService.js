...
class TerminalCliAgentIntegrationService {
    ...
    isCliAgentConnected(terminalId) {
        try {
            ...
            (0, logger_1.terminal)(`❌ [CliAgentIntegration] Error checking CLI Agent connection:`, error);
            return false;
        }
    }
    /**
    ...
    isCliAgentRunning(terminalId) {
        try {
            ...
            (0, logger_1.terminal)(`❌ [CliAgentIntegration] Error checking CLI Agent running status:`, error);
            return false;
        }
    }
    /**
    ...
    handleTerminalOutputForCliAgent(terminalId, data) {
        try {
            ...
            (0, logger_1.terminal)(`❌ [CliAgentIntegration] Error detecting CLI Agent from output:`, error);
        }
    }
    /**
    ...
    handleTerminalInputForCliAgent(terminalId, data) {
        try {
            ...
            (0, logger_1.terminal)(`❌ [CliAgentIntegration] Error detecting CLI Agent from input:`, error);
        }
    }
    /**
    ...
    getConnectedAgentTerminalId() {
        try {
            ...
            (0, logger_1.terminal)(`❌ [CliAgentIntegration] Error getting connected agent terminal ID:`, error);
            return null;
        }
    }
    /**
    ...
    handleTerminalRemoved(terminalId) {
        try {
            ...
            (0, logger_1.terminal)(`🧹 [CliAgentIntegration] CLI Agent state cleaned up for terminal: ${terminalId}`);
        }
        catch (error) {
            (0, logger_1.terminal)(`❌ [CliAgentIntegration] Error handling terminal removal for CLI Agent:`, error);
        }
    }
    /**
    ...
    switchAiAgentConnection(terminalId) {
        try {
            ...
            (0, logger_1.terminal)(`🔄 [CliAgentIntegration] AI Agent connection switched for terminal ${terminalId}:`, result);
            return result;
        }
        catch (error) {
            (0, logger_1.terminal)(`❌ [CliAgentIntegration] Error switching AI Agent connection:`, error);
            return {
                success: false,
    ...
    dispose() {
        try {
            ...
            (0, logger_1.terminal)('❌ [CliAgentIntegration] Error disposing CLI Agent integration service:', error);
        }
    }
}
