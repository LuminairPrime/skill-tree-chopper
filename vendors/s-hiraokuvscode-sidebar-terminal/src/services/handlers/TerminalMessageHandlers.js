...
exports.TerminalMessageHandlerFactory = exports.SplitTerminalHandler = exports.SessionRestorationHandler = exports.UpdateSettingsHandler = exports.GetSettingsHandler = exports.FocusTerminalHandler = exports.TerminalResizeHandler = exports.TerminalInputHandler = exports.DeleteTerminalHandler = exports.CreateTerminalHandler = void 0;
...
class DeleteTerminalHandler extends MessageRouter_1.BaseMessageHandler {
    ...
    async handle(data) {
        ...
        try {
            const success = await this.dependencies.terminalManager.deleteTerminal(data.terminalId, data.force || false);
            if (success) {
