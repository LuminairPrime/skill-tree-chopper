  ...
  getFeatureFlags() {
    ...
    return {
      ...
      scrollbackLineLimit: this.validateScrollbackLimit(
        this.getCachedFlag(
          'scrollbackLineLimit',
          config.get('scrollbackLineLimit', DEFAULT_FEATURE_FLAGS.scrollbackLineLimit)
        )
      ),
      vscodeStandardIME: this.getCachedFlag(
        'vscodeStandardIME',
        config.get('vscodeStandardIME', DEFAULT_FEATURE_FLAGS.vscodeStandardIME)
      ),
      vscodeKeyboardShortcuts: this.getCachedFlag(
        'vscodeKeyboardShortcuts',
        config.get('vscodeKeyboardShortcuts', DEFAULT_FEATURE_FLAGS.vscodeKeyboardShortcuts)
      ),
      vscodeStandardCursor: this.getCachedFlag(
        'vscodeStandardCursor',
        config.get('vscodeStandardCursor', DEFAULT_FEATURE_FLAGS.vscodeStandardCursor)
      ),
      fullANSISupport: this.getCachedFlag(
        'fullANSISupport',
        config.get('fullANSISupport', DEFAULT_FEATURE_FLAGS.fullANSISupport)
      ),
    };
  }
  /**
