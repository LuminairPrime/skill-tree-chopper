...
exports.CliAgentStateStore = exports.CliAgentDetectionEngine = exports.CliAgentPatternRegistry = exports.CliAgentDetectionService = void 0;
...
class CliAgentDetectionService {
    constructor() {
        ...
        this.notificationCoordinator = new NotificationCoordinator_1.NotificationCoordinator(new ToastNotificationService_1.ToastNotificationService(), new NativeNotificationService_1.NativeNotificationService());
        ...
        try {
            ...
            if (/\x03/.test(input)) {
                ...
                if (terminalState && terminalState.status !== 'none') {
                    const immediateTermination = this.detectionEngine.detectImmediateInterruptTermination(terminalId, terminalState.agentType ?? undefined);
...
Object.defineProperty(exports, "CliAgentPatternRegistry", { enumerable: true, get: function () { return CliAgentPatternRegistry_1.CliAgentPatternRegistry; } });
var CliAgentDetectionEngine_2 = require("./CliAgentDetectionEngine");
Object.defineProperty(exports, "CliAgentDetectionEngine", { enumerable: true, get: function () { return CliAgentDetectionEngine_2.CliAgentDetectionEngine; } });
var CliAgentStateStore_2 = require("./CliAgentStateStore");
Object.defineProperty(exports, "CliAgentStateStore", { enumerable: true, get: function () { return CliAgentStateStore_2.CliAgentStateStore; } });
