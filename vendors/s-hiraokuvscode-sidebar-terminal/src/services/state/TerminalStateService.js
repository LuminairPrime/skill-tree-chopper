    ...
    setActiveTerminal(id) {
        ...
        if (this._activeTerminalId && this._activeTerminalId !== id) {
            ...
            if (prevState) {
                ...
                this._publishStateChange(this._activeTerminalId, previousCompleteState, currentCompleteState, 'deactivated');
            }
        }
    ...
    clearActiveTerminal() {
        ...
        if (this._activeTerminalId) {
            ...
            if (state) {
                ...
                const currentState = this._getCompleteState(state);
                this._publishStateChange(this._activeTerminalId, previousState, currentState, 'deactivated');
            }
            this._activeTerminalId = undefined;
        }
    }
