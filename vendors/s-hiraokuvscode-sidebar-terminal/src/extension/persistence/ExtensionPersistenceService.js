...
ExtensionPersistenceService.SESSION_VERSION = '2.0.0';
ExtensionPersistenceService.MAX_STORAGE_SIZE = 20 * 1024 * 1024; // 20MB
ExtensionPersistenceService.RETENTION_DAYS = 7;
