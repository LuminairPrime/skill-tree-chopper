...
class WebViewPersistenceService {
     ...
     */
    async storeLocalSessionData(data) {
        try {
...
WebViewPersistenceService.STORAGE_KEY = 'secondaryTerminal.webview.session';
WebViewPersistenceService.SESSION_VERSION = '2.0.0';
WebViewPersistenceService.MAX_LOCAL_STORAGE_SIZE = 5 * 1024 * 1024; // 5MB
