...
exports.THEME_UI_COLORS = exports.LIGHT_THEME = exports.DARK_THEME = void 0;
exports.getVSCodeThemeColors = getVSCodeThemeColors;
exports.detectVSCodeTheme = detectVSCodeTheme;
/**
 ...
 * UI color constants
 */
exports.THEME_UI_COLORS = {
    ACTIVE_BORDER_COLOR: '#007acc',
    INACTIVE_BORDER_COLOR: '#464647',
    SEPARATOR_COLOR: '#464647',
};
function getCssThemeValue(style, property, fallback = '') {
    return style.getPropertyValue(property).trim() || fallback;
}
function getThemeBase(themeType) {
    return themeType === 'light' ? exports.LIGHT_THEME : exports.DARK_THEME;
}
function getVSCodeThemeColors(themeType) {
    ...
    try {
        ...
        return {
            background: getCssThemeValue(style, '--vscode-terminal-background', getCssThemeValue(style, '--vscode-editor-background', baseTheme.background)),
            foreground: getCssThemeValue(style, '--vscode-terminal-foreground', getCssThemeValue(style, '--vscode-editor-foreground', baseTheme.foreground)),
            cursor: getCssThemeValue(style, '--vscode-terminalCursor-foreground', baseTheme.cursor),
            cursorAccent: baseTheme.cursorAccent,
            selectionBackground: getCssThemeValue(style, '--vscode-terminal-selectionBackground', baseTheme.selectionBackground),
            ...
            brightBlack: getCssThemeValue(style, '--vscode-terminal-ansiBrightBlack', baseTheme.brightBlack),
            brightRed: getCssThemeValue(style, '--vscode-terminal-ansiBrightRed', baseTheme.brightRed),
            brightGreen: getCssThemeValue(style, '--vscode-terminal-ansiBrightGreen', baseTheme.brightGreen),
            brightYellow: getCssThemeValue(style, '--vscode-terminal-ansiBrightYellow', baseTheme.brightYellow),
            brightBlue: getCssThemeValue(style, '--vscode-terminal-ansiBrightBlue', baseTheme.brightBlue),
            brightMagenta: getCssThemeValue(style, '--vscode-terminal-ansiBrightMagenta', baseTheme.brightMagenta),
            brightCyan: getCssThemeValue(style, '--vscode-terminal-ansiBrightCyan', baseTheme.brightCyan),
            brightWhite: getCssThemeValue(style, '--vscode-terminal-ansiBrightWhite', baseTheme.brightWhite),
        };
    }
    catch {
        return baseTheme;
 ...
 */
function detectVSCodeTheme(settings) {
