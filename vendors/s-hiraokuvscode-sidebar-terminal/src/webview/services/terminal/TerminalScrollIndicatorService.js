...
exports.TerminalScrollIndicatorService = void 0;
const ManagerLogger_1 = require("../../utils/ManagerLogger");
class TerminalScrollIndicatorService {
    /**
     ...
     */
    attach(terminal, container, terminalId) {
        try {
            ...
            if (!viewport) {
                ManagerLogger_1.terminalLogger.warn(`Scroll indicator skipped: viewport missing for ${terminalId}`);
                return () => { };
            }
            this.injectStyles();
            ...
            const isAtBottom = () => viewport.scrollTop + viewport.clientHeight >= viewport.scrollHeight - threshold;
            ...
            const onClick = () => {
                try {
                    ...
                    ManagerLogger_1.terminalLogger.warn(`Scroll indicator click failed for ${terminalId}:`, error);
                }
            };
            ...
            ManagerLogger_1.terminalLogger.error(`Failed to attach scroll indicator for ${terminalId}:`, error);
            return () => { };
        }
    }
    /**
...
exports.TerminalScrollIndicatorService = TerminalScrollIndicatorService;
TerminalScrollIndicatorService.stylesInjected = false;
//# sourceMappingURL=TerminalScrollIndicatorService.js.map