...
class TerminalScrollbarService {
    ...
    enableScrollbarDisplay(xtermElement, terminalId) {
        ...
        try {
            ...
            if (!viewport) {
                ManagerLogger_1.terminalLogger.warn(`Viewport not found for terminal ${terminalId}`);
                return;
            }
            ...
            ManagerLogger_1.terminalLogger.info(`VS Code standard full viewport and scrollbar enabled for terminal: ${terminalId}`);
        }
        catch (error) {
            ManagerLogger_1.terminalLogger.error(`Failed to enable scrollbar for terminal ${terminalId}:`, error);
        }
    }
    /**
...
exports.TerminalScrollbarService = TerminalScrollbarService;
TerminalScrollbarService.stylesInjected = false;
//# sourceMappingURL=TerminalScrollbarService.js.map