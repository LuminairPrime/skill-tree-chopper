...
class NotificationService {
    ...
    createNotificationElement(config) {
        ...
        ManagerLogger_1.uiLogger.info(`Created notification: ${config.type} - ${config.title}`);
        return notification;
    }
    /**
    ...
    ensureAnimationsLoaded() {
        ...
        if (!document.querySelector('#ui-manager-animations')) {
            ...
            ManagerLogger_1.uiLogger.debug('CSS animations loaded');
        }
    ...
    createNotificationContainer(colors) {
        return DOMUtils_1.DOMUtils.createElement('div', {
            position: 'fixed',
            top: '20px',
            right: '20px',
    ...
    createNotificationContent(config, colors) {
    ...
    createNotificationCloseButton(colors) {
        return DOMUtils_1.DOMUtils.createElement('button', {
            position: 'absolute',
            top: '4px',
            right: '6px',
            background: 'none',
