...
exports.TerminalBorderService = void 0;
 ...
 */
class TerminalBorderService {
    constructor() {
        this.activeBorderMode = 'multipleOnly';
        this.currentTerminalCount = 1;
    ...
    updateTerminalBorders(activeTerminalId, allContainers) {
        ...
        if (activeContainer) {
            ...
            ManagerLogger_1.uiLogger.warn(`Active container not found: ${activeTerminalId}`);
        }
    }
    /**
    ...
    refreshAllBorders() {
        ...
        ManagerLogger_1.uiLogger.debug(`Refreshed all borders: mode=${this.activeBorderMode}, count=${this.currentTerminalCount}`);
    }
    /**
     * Determine if active border should be shown based on mode, terminal count, and fullscreen state
     */
    shouldShowActiveBorder() {
    ...
    updateSingleTerminalBorder(container, isActive) {
        ...
        const activeBorderColor = `var(--vscode-focusBorder, ${WebviewThemeUtils_1.WEBVIEW_THEME_CONSTANTS.ACTIVE_BORDER_COLOR})`;
        ...
        ManagerLogger_1.uiLogger.debug(`Border updated: ${container.dataset.terminalId}, active: ${isActive}, visible: ${shouldShow}, lightTheme: ${this.isLightTheme}`);
    }
}
exports.TerminalBorderService = TerminalBorderService;
//# sourceMappingURL=TerminalBorderService.js.map