...
exports.VSCodeCommandDispatcher = void 0;
...
class VSCodeCommandDispatcher {
    ...
    handleVSCodeCommand(command, manager) {
        ...
        switch (command) {
            ...
            case 'workbench.action.terminal.split':
                this.deps.emitTerminalInteractionEvent('split-terminal', manager.getActiveTerminalId() || '', undefined, manager);
                break;
            case 'workbench.action.terminal.kill':
                this.deps.emitTerminalInteractionEvent('kill-terminal', manager.getActiveTerminalId() || '', undefined, manager);
                break;
            ...
            case 'workbench.action.terminal.focusNext':
                this.deps.emitTerminalInteractionEvent('switch-next', manager.getActiveTerminalId() || '', undefined, manager);
                break;
            case 'workbench.action.terminal.focusPrevious':
                this.deps.emitTerminalInteractionEvent('switch-previous', manager.getActiveTerminalId() || '', undefined, manager);
                break;
    ...
    shouldInterceptKeyForVSCode(event, terminal, manager) {
        ...
        const isMac = (0, PlatformUtils_1.isMacPlatform)();
        ...
        if (['ArrowUp', 'ArrowDown', 'ArrowLeft', 'ArrowRight'].includes(event.key)) {
            ...
            if (event.ctrlKey && event.shiftKey) {
                this.handleVSCodeCommand(event.key === 'ArrowUp'
                    ? 'workbench.action.terminal.scrollUp'
                    : 'workbench.action.terminal.scrollDown', manager);
                return true;
            }
...
exports.VSCodeCommandDispatcher = VSCodeCommandDispatcher;
//# sourceMappingURL=VSCodeCommandDispatcher.js.map