...
exports.SpecialKeysHandler = void 0;
...
class SpecialKeysHandler {
    ...
    handleSpecialKeys(event, terminalId, manager) {
        ...
        if (event.key === 'Enter' && (event.shiftKey || event.altKey || event.metaKey)) {
            this.deps.logger(`${event.shiftKey ? 'Shift' : event.altKey ? 'Alt' : 'Cmd'}+Enter - sending newline for multiline input`);
            event.preventDefault();
            event.stopPropagation();
...
exports.SpecialKeysHandler = SpecialKeysHandler;
//# sourceMappingURL=SpecialKeysHandler.js.map