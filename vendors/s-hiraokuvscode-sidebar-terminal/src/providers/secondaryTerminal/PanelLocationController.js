...
class PanelLocationController {
    ...
    async handleReportPanelLocation(message) {
        await this.panelLocationService.handlePanelLocationReport(message.location, async (_oldLocation, _newLocation) => {
    ...
    registerVisibilityListener(webviewView) {
        (0, logger_1.provider)('⚠️ [DEPRECATED] PanelLocationController.registerVisibilityListener is deprecated - visibility handled by SecondaryTerminalProvider');
