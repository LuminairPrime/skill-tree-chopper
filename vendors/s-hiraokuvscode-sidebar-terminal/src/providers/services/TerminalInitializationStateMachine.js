...
(function (TerminalInitializationState) {
  ...
  TerminalInitializationState[(TerminalInitializationState['ShellInitializing'] = 4)] =
    'ShellInitializing';
  TerminalInitializationState[(TerminalInitializationState['ShellInitialized'] = 5)] =
    'ShellInitialized';
  TerminalInitializationState[(TerminalInitializationState['OutputStreaming'] = 6)] =
    'OutputStreaming';
  ...
  TerminalInitializationState ||
    (exports.TerminalInitializationState = TerminalInitializationState = {})
);
const STATE_NAMES = {
