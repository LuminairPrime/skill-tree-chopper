...
class PersistenceMessageHandler {
    ...
    async handleSaveSession(data) {
        try {
            ...
            (0, logger_1.extension)(`✅ [MSG-HANDLER] Session saved successfully: ${result.terminalCount} terminals`);
            return {
                success: true,
    ...
    async handleRestoreSession() {
        try {
            ...
            (0, logger_1.extension)(`✅ [MSG-HANDLER] Session restored successfully: ${result.terminalsRestored} terminals`);
            return {
                success: true,
