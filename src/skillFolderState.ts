...
export function getSkillsContainerCheckboxState(childStates: ReadonlyArray<SkillCheckboxState>): SkillCheckboxState {
...
export function getSkillFolderMoveTarget(currentFsPath: string, isChecking: boolean): string | undefined {
